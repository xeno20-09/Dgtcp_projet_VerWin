...
return new class extends Migration
{
    ...
    public function up(): void
    {
        Schema::create('demandes', function (Blueprint $table) {
            ...
            $table->integer('back_secret')->default(0);
            /*************************Les elements du secretaire*********************** */
            ...
            $table->bigInteger('montant_v')->default(0);
            ...
            $table->integer('back_verifi')->default(0);
            /*  $table->json('file')->nullable(); */
            $table->string('pieces')->nullable();
            $table->bigInteger('nombre_doc')->default(0);
            $table->string('refpiece')->nullable();
            ...
            $table
                ->foreign('id_chef_bureau')
                ->references('id')
                ->on('Users');
            $table->integer('vu_chef_bureau')->default(0);
            $table->integer('back_chef_bureau')->default(0);
            $table->string('status_dmd_cb')->nullable();
            $table->string('motif_cb')->nullable();
            /*************************Les elements du chef_bureau*********************** */
            ...
            $table
                ->foreign('id_chef_division')
                ->references('id')
                ->on('Users');
            $table->integer('vu_chef_division')->default(0);
            $table->integer('back_chef_division')->default(0);
            /*************************Les elements du chef_division*********************** */
            ...
            $table->integer('back_damf')->default(0);
