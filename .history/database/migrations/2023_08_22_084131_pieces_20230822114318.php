...
return new class extends Migration
{
    ...
    public function up(): void
    {
        ...
        Schema::create('pieces', function (Blueprint $table) {
            ...
            $table->bigInteger('montantinitial')->default(0);
            $table->foreign('montantinitial')->references('montant')->on('demandes')->onDelete('cascade');
            $table->string('libellepiece')->nullable();
            $table->string('referencespiece')->nullable();
            $table->string('date_piece')->nullable();
            $table->bigInteger('montantligne')->default(0);
