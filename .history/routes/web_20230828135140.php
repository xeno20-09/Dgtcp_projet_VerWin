...
Route::get('/VerificateurCorrection{id}', [App\Http\Controllers\ControllerVerificateur::class, 'form_corre'])->name('get_Route::get('/VerificateurMj{id}', [App\Http\Controllers\ControllerVerificateur::class, 'form'])->name('get_update_form_ask_verificateur');
_form_ask_verificateur');
