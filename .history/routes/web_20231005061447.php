...
Route::post('/get-devis', 'ControllerSecretaire@getD');
Route::post('/CorrectionDemandeSave{id}', [App\Http\Controllers\ControllerSecretaire::class, 'store_correction_form_ask'])
