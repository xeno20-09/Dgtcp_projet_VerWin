...
Route::get('/ListeDemandesN', [App\Http\Controllers\ControllerVerificateur::class, 'get_list_ask_n_verificateur']);Route::get('/Verificateur/{id}', [App\Http\Controllers\ControllerVerificateur::class, 'formulaire'])->name('voir_demande');
Route::get('/Formulaire/{id_user}', [App\Http\Controllers\ControllerVerificateur::class, 'get_form_ask'])->name('get_form_ask_verificateur');Route::get('/Listedemande', [App\Http\Controllers\ControllerVerificateur::class, 'liste'])->name('liste_demande');
Route::get('/Listepiece', [App\Http\Controllers\ControllerVerificateur::class, 'listep'])->name('liste_piece');
