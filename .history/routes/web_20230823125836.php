...
Route::get('/Formulaire', [App\Http\Controllers\ControllerSecretaire::class, 'get_form'])->name('get_form');
Route::post('/FormulaireSave{id_user}', [App\Http\Controllers\ControllerSecretaire::class, 'store_form'])->name('store_form');
...
Route::get('/MiseAJourDemande{id_user}', [App\Http\Controllers\ControllerSecretaire::class, 'get_update_form'])->name('formulaire_demande_mj');
...
Route::post('/SecretaireS_dmd', [App\Http\Controllers\ControllerSecretaire::class, 'suite_dmd'])->name('suite_dmd');
