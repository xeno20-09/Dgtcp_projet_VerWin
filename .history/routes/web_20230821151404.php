...
Route::get('/VerificateurMj{id}', [App\Http\Controllers\ControllerDivision::class, 'form'])->name('formulairecb_demande_mj');
Route::post('/DivisControllerDivisionS_Mj{id}', [App\Http\Controllers\ControllerDivision::class, 'store'])->name('le_store_formulaire');
