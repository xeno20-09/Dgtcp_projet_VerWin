...
Route::get('/laliste/pdf/{status}/{sdate}/{fdate}/{devise}', [App\Http\Controllers\ControllerAdminSGBD::class, 'lalisteetatsPDF'])->name('lalisteetats.pdf');


{{ route('lalisteetats.pdf', ['test' => $test]) 
