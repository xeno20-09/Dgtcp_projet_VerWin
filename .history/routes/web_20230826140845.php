...
Route::get('/ListeDemandesN_verificateur', [App\Http\Controllers\ControllerVerificateur::class, 'get_list_ask_n_verificateur']);
Route::get('/Formulaire_verificateur/{id_user}', [App\Http\Controllers\ControllerVerificateur::class, 'get_form_ask'])->name('get_form_ask_verificateur');
Route::post('/FormulaireSave_verificateur{id_user}', [App\Http\Controllers\ControllerVerificateur::class, 'store_form_ask'])->name('store_form_ask_verificateur');
Route::get('/ListePiece', [App\Http\Controllers\ControllerVerificateur::class, 'get_list_piece'])->name('get_list_piece_verificateur');
Route::get('/ListeDemandes_verificateur', [App\Http\Controllers\ControllerVerificateur::class, 'get_list_ask'])->name('get_list_ask_verificateur');
...
Route::get('/RechecherDemande_verificateur{id}',  [App\Http\Controllers\Controller::class, 'get_search_ask'])->name('get_search_ask_verificateur');
