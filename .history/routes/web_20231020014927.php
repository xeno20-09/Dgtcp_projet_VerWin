...
Route::get('/rejtpieces{id}{libellePiece}{referencePiece}{datePiece}{date}{restant}{, $montantligne[$i],$montantdmd,$}', [App\Http\Controllers\ControllerVerificateur::class, 'rejet'])->name('rejet_piece_verificateur');
