...
Route::get('/rejtpieces{id}{libellePiece}{referencePiece}{datePiece}{date}{restant}{, $montantligne}', [App\Http\Controllers\ControllerVerificateur::class, 'rejet'])->name('rejet_piece_verificateur');
