...
Route::get('/retour_cb{id}', [App\Http\Controllers\ControllerVerificateur::class, 'retour'])->name('retour_cb');
...
Route::get('/retour_cb{id}', [App\Http\Controllers\ControllerDivision::class, 'retour'])->name('retour_cb');
...
Route::get('/retour_cb{id}', [App\Http\Controllers\ControllerBureau::class, 'retour'])->name('retour_cb');
