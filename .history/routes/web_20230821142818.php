...
Route::get('/Mj{id}', [App\Http\Controllers\Controller::class, 'form'])->name('formulaire_demande_mj');
Route::post('/S_Mj{id}', [App\Http\Controllers\Controller::class, 'store_mj'])->name('store_dmd_mj');
