...
Route::get('/Secretaire', [App\Http\Controllers\ControllerSecretaire::class, 'formulai'])->name('formulaire_demande');
Route::post('/Secretaire{id}', [App\Http\Controllers\ControllerSecretaire::class, 'store'])->name('store_formulaire_demande');
...
Route::get('/searchs{id}',  [App\Http\Controllers\Controller::class, 'search'])->name('info.search.s');
...
Route::get('/detaille/{id}', [App\Http\Controllers\ControllerVerificateur::class, 'detaille'])->name('detaille_demandes');
Route::get('/searchv{id}',  [App\Http\Controllers\Controller::class, 'search'])->name('info.search.v');
...
Route::get('/searchd{id}',  [App\Http\Controllers\Controller::class, 'search'])->name('info.search.cd');
...
Route::get('/searchb{id}',  [App\Http\Controllers\Controller::class, 'search'])->name('info.search.cb');
...
Route::get('/searchD{id}',  [App\Http\Controllers\Controller::class, 'search'])->name('info.search.d');
...
Route::get('/search{id}',  [App\Http\Controllers\Controller::class, 'search'])->name('info.search');
 */
