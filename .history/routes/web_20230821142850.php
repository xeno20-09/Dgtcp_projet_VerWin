...
Route::get('/VerificateurMj{id}', [App\Http\Controllers\ControllerVerificateur::class, 'form'])->name('formulaire_demande_mj');
Route::post('/VerificateurS_Mj{id}', [App\Http\Controllers\ControllerVerificateur::class, 'store_mj'])->name('storev_dmd_mj');
