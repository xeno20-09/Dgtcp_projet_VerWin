...
Route::get('/CorrectionDemande{id_user}', [App\Http\Controllers\ControllerSecretaire::class, 'get_correction_form_ask'])->name('get_update_form_ask');
Route::post('/CorrectionDemandeSave{id_user}', [App\Http\Controllers\ControllerSecretaire::class, 'store_correction_form_ask'])->name('store_update_form_ask');
