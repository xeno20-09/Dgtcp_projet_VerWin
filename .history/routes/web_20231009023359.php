...
Route::get('/Etat Pays', [App\Http\Controllers\ControllerAdminSGBD::class, 'getetatdmd'])->name('lespays');
Route::get('/Etat Societes', [App\Http\Controllers\ControllerAdminSGBD::class, 'getetatdmd'])->name('lessocietes');
Route::get('/Etat Devis', [App\Http\Controllers\ControllerAdminSGBD::class, 'getetatdmd'])->name('lesdevis');
