...
Route::get('/rejtpieces{id}', [App\Http\Controllers\ControllerVerificateur::class, 'form_corre'])->name('get_correction_form_ask_verificateur');

Route::post('/VerificateurS_corr/{id}', [App\Http\Controllers\ControllerVerificateur::class, 'store_corr'])->name('le_store_corr');

rejet_piece_verificateur
