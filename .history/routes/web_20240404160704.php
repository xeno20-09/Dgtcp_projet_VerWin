...
Route::get(
    '/HSecretaire', [
    App\Http\Controllers\ControllerSecretaire::class,
    'home'
    ]
);
Route::get('/Formulaire', [App\Http\Controllers\ControllerSecretaire::class, 'getFormAsk'])->name('get_form_ask');
Route::post(
    '/FormulaireSave{id_user}',
    [App\Http\Controllers\ControllerSecretaire::class, 'store_form_ask']
)->name('store_form_ask');

Route::get(
    '/ListeDemandes',
    [App\Http\Controllers\ControllerSecretaire::class, 'get_list_ask']
)->name('get_list_ask');

Route::get(
    '/ListeDetaille{id_ask}',
    [App\Http\Controllers\ControllerSecretaire::class, 'get_list_details_ask']
)->name('get_list_details_ask');

Route::get(
    '/RechecherDemande{id_user}',
    [App\Http\Controllers\Controller::class, 'get_search_ask']
)->name('get_search_ask');

Route::get(
    '/MiseAJourDemande{id_user}',
    [App\Http\Controllers\ControllerSecretaire::class, 'get_update_form_ask']
)->name('get_update_form_ask');
Route::post(
    '/MiseAJourDemandeSave{id_user}',
    [App\Http\Controllers\ControllerSecretaire::class, 'store_update_form_ask']
)->name('store_update_form_ask');
...
Route::get(
    '/ListeBack',
    [App\Http\Controllers\ControllerSecretaire::class, 'listeretour']
)->name('get_list_back');

Route::get(
    '/CorrectionDemande{id}',
    [App\Http\Controllers\ControllerSecretaire::class, 'get_correction_form_ask']
)->name('get_correction_form_ask');

Route::post(
    '/CorrectionDemandeSave{id}',
    [App\Http\Controllers\ControllerSecretaire::class, 'store_correction_form_ask']
)->name('store_correction_form_ask');

Route::post(
    '/get-devis',
    [
        App\Http\Controllers\ControllerSecretaire::class, 'getD']
);

Route::post(
    '/get-info', 
    [App\Http\Controllers\ControllerSecretaire::class, 'getInfo']
);
