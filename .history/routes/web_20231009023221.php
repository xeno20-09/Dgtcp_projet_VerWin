...
Route::get('/user/pdf', [App\Http\Controllers\ControllerAdminSGBD::class, 'createPDF']);
Route::get('/Etat', [App\Http\Controllers\ControllerAdminSGBD::class, 'getetatdmd'])->name('etatdmd');Route::get('/user/pdf', [App\Http\Controllers\ControllerAdminSGBD::class, 'createPDF']);
Route::get('/Etat', [App\Http\Controllers\ControllerAdminSGBD::class, 'getetatdmd'])->name('etatdmd');
/******************************************************************************* */
