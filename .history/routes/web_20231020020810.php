...
Route::post('/rejtpieces/{id}/{libellePiece}/{referencePiece}/{datePiece}/{date}/{restant}/{montantligne}/{montantdmd}', [App\Http\Controllers\ControllerVerificateur::class, 'rejet'])->name('rejet_piece_verificateur');
