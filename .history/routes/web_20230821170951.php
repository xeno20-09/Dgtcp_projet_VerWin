...
Route::get('/VerificateurMj{id}', [App\Http\Controllers\ControllerDivision::class, 'form'])->name('formulairecd_demande_mj');
...
Route::get('/chef_bureaurMj{id}', [App\Http\Controllers\ControllerDivision::class, 'form'])->name('formulairecb_demande_mj');
