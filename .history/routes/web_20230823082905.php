...
Route::get('/formulaire_demande', [App\Http\Controllers\ControllerSecretaire::class, 'formulai'])->name('formulaire_demande');
...
Route::post('/SecretaireS_Mj{id}', [App\Http\Controllers\ControllerSecretaire::class, 'store_suite_dmd'])->name('store_suite_dmd');
