...
Route::get('/Ajout devises/{id}', ['as' => 'adddevises', 'adddevise' => 'ControllerDivision@adddevise'] /* [App\Http\Controllers\ControllerDivision::class, 'adddevise'] */)/* ->name('adddevises') */;
