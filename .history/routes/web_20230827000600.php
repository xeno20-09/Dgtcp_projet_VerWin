...
Route::get('/retour_cb{id}', [App\Http\Controllers\ControllerDivision::class, 'retour'])->name('retour_v');
...
Route::get('/retour_cb{id}', [App\Http\Controllers\ControllerBureau::class, 'retour'])->name('retour_cd');
