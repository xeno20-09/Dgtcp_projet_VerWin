...
Route::post('/Ajout devises/{id}', [App\Http\Controllers\ControllerDivision::class, 'adddevise'])->name('addcours
');
//Route::gett('/insertion', 'VotreController@inserer')->name('insertion');
