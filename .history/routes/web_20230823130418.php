...
Route::get('/RechecherDemandeSuite', [App\Http\Controllers\ControllerSecretaire::class, 'get_search_ask_suite'])->name('get_search_ask_suite');
Route::post('/RechecherLaDemandeSuite{id}',  [App\Http\Controllers\ControllerSecretaire::class, 'store_search_ask_suite'])->name('get_search_ask_suite');
Route::post('/FormulaireSuiteSave', [App\Http\Controllers\ControllerSecretaire::class, 'suite_dmd'])->name('suite_dmd');
