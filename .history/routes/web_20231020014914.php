...
Route::get('/rejtpieces{id}{libellePiece}{referencePiece}{datePiece}{date}{}', [App\Http\Controllers\ControllerVerificateur::class, 'rejet'])->name('rejet_piece_verificateur');
