...
Route::get('/CorrectionDemande{id_user}', [App\Http\Controllers\ControllerSecretaire::class, 'get_correction_form_ask'])->name('get_correction_form_ask');
Route::post('/CorrectionDemandeSave{id_user}', [App\Http\Controllers\ControllerSecretaire::class, 'store_correction_form_ask'])->name('store_correction_form_ask');
...
Route::get('/VerificateurCorrection{id}', [App\Http\Controllers\ControllerVerificateur::class, 'form_corre'])->name('get_Route::get('/VerificateurMj{id}', [App\Http\Controllers\ControllerVerificateur::class, 'form'])->name('get_update_form_ask_verificateur');_form_ask_verificateur');
