...
Route::get('/VerificateurMj{id}', [App\Http\Controllers\ControllerVerificateur::class, 'formu'])->name('formulaire_demande_mj');
Route::post('/VerificateurS_Mj{id}', [App\Http\Controllers\ControllerVerificateur::class, 'store_mj'])->name('store_dmd_mj');
