...
Route::post('/Secretaire{id}', [App\Http\Controllers\ControllerSecretaire::class, 'storeform'])->name('store_formulaire_demande');
...
Route::post('/SecretaireS_dmd{id}', [App\Http\Controllers\ControllerSecretaire::class, 'suite_dmd'])->name('suite_dmd');
