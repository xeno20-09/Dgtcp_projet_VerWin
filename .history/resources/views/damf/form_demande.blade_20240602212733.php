                ...
                <div class="col">
                    <div class="form-group">
                        ...
                        <input name="pieces_doss[]" type="text" value="{{ $item_d->libellepiece }}" class="form-control"
                            id="pieces" placeholder="pieces" readonly>
                    </div>
                </div>
                ...
                <div class="col">
                    <div class="form-group">
                        ...
                        <input name="ref_doss[]" type="text" class="form-control" value="{{ $item_d->referencespiece }}"
                            id="refs" placeholder="ref pieces" readonly>
                    </div>
                </div>
                <div class="col">
                    <div class="form-group">
...
<div class="row">
    ...
    <div class="col">
        <div class="form-group">
            ...
            <input name="prenom_benifi" value="{{ $item_c->prenom_benefi }}" type="text" class="form-control" id=""
                placeholder="Prenom du beneficiaire" readonly>
        </div>
    </div>
    <div class="col">
        <div class="form-group">
            <label for="" class="form-label mt-4">Profession du beneficiaire</label>
            <input name="profess_benifi" value="{{ $item_c->profess_benefi }}" type="text" class="form-control" id=""
                placeholder="Profession du beneficiaire" readonly>
        </div>
    </div>
...
<div class="row">
    ...
    <div class="col">
        <div class="form-group">
            ...
            <input name="banque_benifi" value="{{ $item_c->banque_benefi }}" type="text" class="form-control" id=""
                placeholder="Banque" readonly>
        </div>
    </div>
    <div class="col">
        <div class="form-group">
            <label for="" class="form-label mt-4">Numéro de compte du beneficiaire</label>
            <input name="num_compt_benifi" value="{{ $item_c->num_compt_benefi }}" type="text" class="form-control"
                id="" placeholder="Numéro de compte" readonly>
        </div>
    </div>
...
<div class="row">
    ...
    <div class="col">
        <div class="form-group">
            ...
            <input name="date_decision" value="{{ $item_c->date_decision }}" type="text" class="form-control" id=""
                placeholder="Date de decision" readonly>
        </div>
    </div>
</div>
<br><br>
