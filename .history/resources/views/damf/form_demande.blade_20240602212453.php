...
<div class="container">
    ...
    <form action="{{ route('store_formulaire_dmd', $item_c->id) }}" method="Post"
        ...
        <div class="row">
            <legend>Demande agent de saisir</legend>
            <hr>
            ...
            <div class="col">
                <div class="form-group">
                    ...
                    <input value="{{ $item_c->date }}" name="date_depot" type="date" class="form-control" id=""
            ...
            <div class="col">
                <div class="form-group">
                    ...
                    <input value="{{ $item_c->nature_op }}" name="nature_op" type="text" class="form-control" id=""
            ...
            <div class="col">
                <div class="form-group">
                    ...
                    <input value="{{ $item_c->nature_p }}" name="nature_pro" type="text" class="form-control" id=""
        ...
        <div class="row">
            <div class="col">
                <div class="form-group">
                    ...
                    <input value="{{ $item_c->devise }}" name="currency_from" type="text" class="form-control" id=""
                        placeholder="">
                </div>
            </div>
            <div class="col">
                <div class="form-group">
                    ...
                    <input value="{{ $item_c->montant }}" name="montant_in" type="number" class="form-control" id=""
        ...
        <div class="row">
            ...
            <div class="col">
                <div class="form-group">
                    ...
                    <input value="{{ $item_c->nom_client }}" name="nom_client" type="text" class="form-control" id=""
            ...
            <div class="col">
                <div class="form-group">
                    ...
                    <input value="{{ $item_c->prenom_client }}" name="prenom_client" type="text" class="form-control"
            ...
            <div class="col">
                <div class="form-group">
                    ...
                    <input value="{{ $item_c->tel_client }}" name="tel_client" type="text" class="form-control" id=""
        ...
        <div class="row">
            ...
            <div class="col">
                <div class="form-group">
                    ...
                    <input value="{{ $item_c->banque_client }}" name="banque_client" type="text" class="form-control"
                        id="" placeholder="Banque">
                </div>
            </div>
            <div class="col">
                <div class="form-group">
                    <label for="" class="form-label mt-4">Profession demandeur</label>
                    <input value="{{ $item_c->profess_client }}" name="profess_client" type="text" class="form-control"
                        id="" placeholder="ProfClient" readonly>
                </div>
            </div>
            <div class="col">
                <div class="form-group">
            ...
            <div id="container" style="  width: 1362px;">
                <div class="row">
                    <div class="col">
                        <div class="form-group">
                            <label for="" class="form-label mt-4">Intitulé de la pièces</label>
                    ...
                    <div class="col">
                        <div class="form-group">
                            <label for="" class="form-label mt-4">Reference de la piece</label>
                    ...
                    <div class="col">
                        <div class="form-group">
                            ...
                            <input name="exp_pieces[]" value="{{ $item_d->dateexpi }}" type="date" class="form-control"
                                id="expi" placeholder="date expiration pieces" readonly>
                        </div>
                    </div>
        ...
        <div class="row">
            ...
            <div class="col">
                <div class="form-group">
                    <label for="" class="form-label mt-4">Pays du benificiaire</label>
            ...
            <div class="col">
                <div class="form-group">
                    ...
                    <input name="date_decision" value="{{ $item_c->date_decision }}" type="text" class="form-control"
                        id="" placeholder="Date de decision" readonly>
                </div>
            </div>
        </div>
        <br><br>
        <legend>Demande du Chef Service</legend>
        <hr>
        ...
        <div class="row">
            ...
            <div class="col">
                ...
                <div class="form-group">
                    ...
                    <input name="motif" value="{{ $item_c->status_dmd_cb }}" type="text" class="form-control" id=""
            ...
            <div class="col">
                <div class="form-group">
                    ...
                    <input name="motif" value="{{ $item_c->motif_cb }}" type="text" class="form-control" id=""
...
{{--         <br><br>
        ...
        <div class="row">
            ...
            <div class="col">
                ...
                <div class="form-group">
                    <label for="exampleSelect1" class="form-label mt-4">Autorisation</label>
            ...
            <div class="col">
                <div class="form-group">
                    <label for="" class="form-label mt-4">Motif du rejet ou de la suspension</label>
                    <input name="motif" value="{{ $item_c->motif }}" type="text" class="form-control" id=""
                        placeholder="Motif">
                </div>
            </div>
        ...
        <br>
        <button type="submit" class="btn btn-primary">Vu & approuvé !</button>
    </form>
    <a href="{{ url('retour_cb', $item_c->id) }}"><button class="btn btn-danger">Retournez la
            demande au Chef Service </button></a>
    @endforeach
