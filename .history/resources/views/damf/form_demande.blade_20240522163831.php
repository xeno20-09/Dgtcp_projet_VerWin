    ...
    <div class="container">
        ...
        @foreach ($demande as $item_c)
            ...
            <form action="{{ route('store_formulaire_dmd', $item_c->id) }}" method="Post"
                ...
                <div class="row">
                    ...
                    <div class="col">
                        <div class="form-group">
                            ...
                            <input value="{{ $item_c->montant_con }}" name="montant_out" type="number"
                                class="form-control" id="" placeholder="Montant converti">
                        </div>
                    </div>
                </div>
                ...
                <br>
                <button type="submit" class="btn btn-primary">VU & APPROUVe</button>
            </form>
