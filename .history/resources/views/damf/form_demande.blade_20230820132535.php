                ...
                <div class="row">
                    ...
                    <div class="row">
                        ...
                        <div class="col">
                            ...
                            <div class="form-group">
                                <input value="{{ $item_c->visa_chef_bureau }}" class="form-check-label"
                                    name="visa_chef_bureau" type="checkbox" id="exampleCheckbox">
                    ...
                    <div class="row">
                        ...
                        <div class="col">
                            ...
                            <div class="form-group">
                                ...
                                <select value="{{ $item_c->status_dmd_cb }}" name="status" class="form-select" id="exampleDisabledSelect1">
                         
                                </select>
                                <label for="" class="form-label mt-4">Motif du rejet ou de la suspension</label>
                                <input name="motif" value="{{ $item_c->status_dmd_cb }}" type="text" class="form-control"
                                    id="" placeholder="">
                            </div>
