...
@section('content')
    <div class="container">
        ...
        @foreach ($demande as $item_c)
            ...
            <option value="Bank of Africa Bénin">Euro</option>
            <option value="Banque internationale du Bénin">Dollar us</option>
            <option value="Banque de l'habitat du Bénin">Yen japonais</option>
            <option value="Ecobank">Livre sterling</option>
            <option value="Orabank Bénin">Franc suisse</option>
            <option value="United Bank of Africa">Dollar canadien</option>
            <option value="Diamond Bank">Yuan chinois</option>
            <option value="Société générale de banques du Bénin">Dirham Emirats Arabes Unis</option>
