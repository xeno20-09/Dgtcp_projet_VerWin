            ...
            <form action="{{ route('store_formulaire_demanded', $item_c->id) }}" method="Post"
                ...
                <div class="row">
                    ...
                    <div class="col">
                        ...
                        Dollar us 	622,500 	629,500
                        Yen japonais 	4,175 	4,235
                        Livre sterling 	752,500 	759,500
                        Franc suisse 	677,750 	683,750
                        Dollar canadien 	453,250 	460,250
                        Yuan chinois 	85,000 	86,750
