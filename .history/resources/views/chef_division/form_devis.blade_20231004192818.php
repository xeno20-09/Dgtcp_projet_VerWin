                ...
                <div class="row">
                    ...
                    <div class="col">
                        <div class="form-group">
                            ...
                            <input value="" name="valeur" type="number" class="form-control" id="" placeholder="Cours">
                            @php
                                
                            @endphp
                            <input value="" name="valeur" type="number" class="form-control" id="" placeholder="Cours" hidden>
