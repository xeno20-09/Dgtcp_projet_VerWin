...
@section('content')
   ...
   --}}
        ...
        <div style="position:relative;display:flex;flex-direction:row;">
            @foreach ($user as $item)
                <a href="{{ route('devises', $item->id) }}"><button type="button" class="btn btn-danger"><i
                            class="fas fa-exclamation"></i> Mettre à jour les devises</button></a>
            @endforeach
            <button type="button" style="margin-left: 60px;" class="btn btn-primary" data-bs-toggle="modal"
