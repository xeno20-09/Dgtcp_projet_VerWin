...
@section('content')
    <div class="container">
        ...
        @foreach ($demande as $item_c)
            ...
            <form action="{{ route('le_store_corr', $item_c->id) }}" method="Post" class="card-body cardbody-color p-lg-5">
                ...
                <div class="row">
                    ...
                    <div class="col">
                        <div class="form-group">
                            ...
                            <input name="date_depot" type="texte" value="{{ $item_c->date }}" class="form-control"
                    ...
                    <div class="col">
                        <div class="form-group">
                            ...
                            <input name="type_prs" type="texte" value="{{ $item_c->type_prs }}" class="form-control"
                                id="" aria-describedby="" placeholder="">
                        </div>
                    </div>
                    <div class="col">
                        <div class="form-group">
                            ...
                            <input name="num_save" type="texte" value="{{ $item_c->num_save }}" class="form-control"
                                id="" aria-describedby="" placeholder="">
                        ...
                        <div class="row">
                            <div class="col">
                                <div class="form-group">
                                    ...
                                    <input name="nature_op" value="{{ $item_c->nature_op }}" type="text"
                                        class="form-control" id="" placeholder="Nature des opérations">
                            ...
                            <div class="col">
                                <div class="form-group">
                                    ...
                                    <input name="nature_pro"value="{{ $item_c->nature_p }}" type="text"
                                        class="form-control" id="" placeholder="Nature des produits">
                            ...
                            <div class="col">
                                <div class="form-group">
                                    ...
                                    <input name="boite" type="text" value="{{ $item_c->boite }}" class="form-control"
                        ...
                        <div class="row">
                            ...
                            <div class="col">
                                <div class="form-group">
                                    ...
                                    <input name="currency_from" value="{{ $item_c->devise }}" type="text"
                                        class="form-control">
                            ...
                            <div class="col">
                                <div class="form-group">
                                    ...
                                    <input name="montant_in" value="{{ $item_c->montant }}" type="number"
                                        class="form-control" oninput="test1()" id="montant_in_m" placeholder="Montant ">
                                </div>
                            </div>
                            ...
                            <div class="col"id="valeur_m">
                                <div class="form-group">
                                    ...
                                    <input name="valeur" type="text" class="form-control"
                                        value="{{ $item_c->valeur }}"id="val1" placeholder="Valeur" readonly>
                                </div>
                            </div>
                            <div class="col"id="mont_fcfa_m">
                                <div class="form-group">
                                    ...
                                    <input name="mont_fcfa" type="text" class="form-control"
                                        value="{{ $item_c->montant_con }}" id="montant_fcfa_m"
                            ...
                            <div class="col">
                                <div class="form-group">
                                    ...
                                    <input name="nomsociete" type="text" class="form-control"
                                        value={{ $item_c->nomsociete }} id="nom" placeholder="Nom societe">
                                </div>
                            </div>
                            <div class="col">
                                <div class="form-group">
                                    ...
                                    <input name="categorie" type="text" value={{ $item_c->categorie }}
                                        class="form-control" id="prenom" placeholder="Catégorie">
                                </div>
                            </div>
                            ...
                            <div class="col">
                                <div class="form-group">
                                    ...
                                    <input name="adresse" type="text"
                                        value="{{ $item_c->adresse }}"class="form-control" id=""
                                        placeholder="Adresse">
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col">
                                <div class="form-group" style="position: relative;top: 15px;">
                                    ...
                                    <input id="phone" type="tel" name="tel_client"
                                        value="{{ $item_c->tel_client }}" class="form-control" style=""
                        ...
                        <div class="row">
                            ...
                            <div class="col">
                                <div class="form-group">
                                    ...
                                    <input name="nationalite" value="{{ $item_c->nationalite }}" type="text"
                        ...
                        <div class="row">
                            ...
                            <div class="col">
                                <div class="form-group">
                                    <label for="" class="form-label mt-4">Montant </label>
                                    <input name="montant_in" value="{{ $item_c->montant }}" type="number"
                                        oninput="test()" class="form-control" id="montant_in" placeholder="Montant ">
                                </div>
                            </div>
                            ...
                            <div class="col" id="valeur_p">
                                <div class="form-group">
                                    <label for="" class="form-label mt-4">Valeur </label>
                                    <input name="valeur" type="text" id="val" value="{{ $item_c->valeur }}"
                            ...
                            <div class="col" id="mont_fcfa_p">
                                <div class="form-group">
                                    <label for="" class="form-label mt-4">Contre montant </label>
                                    <input name="mont_fcfa" type="text" class="form-control"
                                        value="{{ $item_c->montant_con }}" id="montant_fcfa"
                                        placeholder="Contre montant" readonly>
                                </div>
                            </div>
                        ...
                        <div class="row">
                            <div class="col">
                                <div class="form-group">
                                    ...
                                    <input name="nom_client" type="text" value="{{ $item_c->nom_client }}"
                                        class="form-control" id="nom" placeholder="Nom client">
                                </div>
                            </div>
                            <div class="col">
                                <div class="form-group">
                        ...
                        <div class="row">
                            ...
                            <div class="col">
                                <div class="form-group">
                                    ...
                                    <input maxlength="14" minlength="12" value="{{ $item_c->tel_client }}"
                                        name="tel_client" type="number" class="form-control" id=""
                                        placeholder="TelClient">
                                </div>
                            </div>
                            ...
                            <div class="col">
                                <div class="form-group">
                                    ...
                                    <input maxlength="12" minlength="12" name="num_compt_client"
                                        value="{{ $item_c->num_compt_client }}" type="number" class="form-control"
                                ...
                                <div class="col">
                                    <div class="form-group">
                                        ...
                                        <input name="pieces_doss[]" type="text" value="{{ $item_d->libellepiece }}"
                                            class="form-control" id="pieces" placeholder="pieces">
                                    </div>
                                </div>
                                ...
                                <div class="col">
                                    <div class="form-group">
                                        ...
                                        <input name="ref_doss[]" type="text"
                                            class="form-control"value="{{ $item_d->referencespiece }}" id="refs"
                                            placeholder="ref pieces">
                                    </div>
                                </div>
                                <div class="col">
                                    <div class="form-group">
                                        ...
                                        <input name="montantligne[]" type="number" class="form-control"
                                            value="{{ $item_d->montantligne }}" id="mligne"
                                ...
                                <div class="col">
                                    <div class="form-group">
                                        <label for="" class="form-label mt-4">Date d'expiration de la
                                            piece</label>
                                        <input name="exp_pieces[]" value="{{ $item_d->dateexpi }}" type="date"
                                            class="form-control" id="expi" placeholder="date expiration pieces">
                                    </div>
                                </div>
