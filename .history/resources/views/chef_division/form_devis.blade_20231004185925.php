    ...
    <div class="container">
        ...
        <a href="{{ route('adddevises', ['id' => $item->id]) }}" data-bs-toggle="modal">
            <button type="button" data-bs-toggle="modal" class="btn btn-primary">Ajouter une devise</button>
              ...
              <button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#insertionModal">
                Ajouter une devise             
             </button>
                ...
                <div class="modal-dialog">
                  <div class="modal-content">
                    <div class="modal-header">
                      <h5 class="modal-title" id="insertionModalLabel">Ajouter des données</h5>
                      <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                    </div>
                    <div class="modal-body">
                        {!! Form::open(['rooute' => 'adddevise']) !!}
                        <div class="mb-3">
                            {!! Form::label('Devise', 'Devise') !!}
                            {!! Form::text('Devise', '', ['class' => 'form-control', 'placeholder' => 'Entrez le nom de la devise', 'required']) !!}
                        </div>
                        {!! Form::close() !!}                    
                    </div>
                ...
                <div class="row">
                    ...
                    <div class="col">                        
                        <div class="form-group">
                            ...
                            <option value="{{$name->name}}">{{$name->nom}}</option>
                            @endforeach
