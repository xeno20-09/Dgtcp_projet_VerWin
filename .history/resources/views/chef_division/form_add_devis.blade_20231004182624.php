...
@section('content')
    <div class="container">
        ...
        <a href="{{ route('adddevises', $item->id) }}"><button type="button" class="btn btn-primary">Ajouter une devise</button></a>
      @endforeach
              ...
              <div class="modal-body">
                      {!! Form::open(['url' => 'save']) !!}
                          <div class="mb-3">
                              ...
                              {!! Form::text('Devise', '', ['class' => 'form-control', 'placeholder' => 'Input Firstname', 'required']) !!}
                          </div>
