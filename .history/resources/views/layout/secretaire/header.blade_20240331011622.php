...
<head>
    ...
    --}}
    @vite([ 'resources/js/toastr.js', 'resources/css/toastr.css'])
...
<body>
            ...
            <div class="container-fluid">
                ...
                <div class="collapse navbar-collapse" id="navbarColor01">
                    <ul class="navbar-nav me-auto">
                        ...
                        <li class="nav-item">
                            <a class="nav-link" href="{{ route('logout') }}"
                                ...
                                {{ Auth::user()->lastname }}<i class='fas fa-sign-out-alt'
                    ...
                    <form class="d-flex flex-row gap-3" style="width: 32%;position: relative;left: 120px;top: 72px;"
                        action="{{ route('get_search_ask', $item->id) }}" method="GET">
                        <input class="form-control" type="search" name="query" value="{{ request()->input('query') }}"
    ...
    <div class="container">
        <ul class="nav nav-pills mt-3">
            ...
            <li class="nav-item">
                <a class="nav-link" href="{{ route('get_form_ask') }}">Saisir une demande</a>
            </li>
            <li class="nav-item">
                <a class="nav-link" href="{{ route('get_list_ask') }}">Liste des demandes</a>
            </li>
    ...
    //cdnjs.cloudflare.com/ajax/libs/toastr.js/latest/css/toastr.css"></script>
