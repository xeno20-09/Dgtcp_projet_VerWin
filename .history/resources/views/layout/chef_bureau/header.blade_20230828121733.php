            ...
            <div class="container-fluid">
                ...
                <div class="collapse navbar-collapse" id="navbarColor01">
                    <ul class="navbar-nav me-auto">
                        ...
                        <li class="nav-item">
                            <a class="nav-link active" href="{{ url('HChef_bureau') }}">Home</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link active" href="{{ url('liste_demand_n') }}">Saisir une demande</a>
                        </li>
                        <li class="nav-item">
        ...
        <li class="nav-item">
          <a class="nav-link" href="#">About</a>
                ...
                <li style="list-style-type: none;" class="nav-item">
                   ...
                   <a href="{{ route('get_list_back_b') }}"><span class="badge rounded-pill badge-notification bg-danger blink-animation"
