...
<body>
            ...
            <div class="container-fluid">
                ...
                <div class="collapse navbar-collapse" id="navbarColor01">
                    ...
                    <form class="d-flex flex-row gap-3" style="width: 32%;position: relative;left: 120px;top: 72px;"
                        action="{{ route('info.search.cb', $item->id) }}" method="GET">
                ...
                <li style="list-style-type: none;" class="nav-item">
                    <a href="{{ route('get_list_back_b') }}"><i class="fas fa-bell" style="font-size:48px;"></i></a>
                    <style>
                        @keyframes blink {
                            0% {
                                opacity: 1;
                    ...
                    <a href="{{ route('get_list_back_b') }}"><span
    ...
    <div class="container">
        <ul class="nav nav-pills mt-3">
            <li class="nav-item">
                <a class="nav-link s" href="{{ url('HChef_bureau') }}">Home</a>
            </li>
            <li class="nav-item">
                <a class="nav-link s" href="{{ url('liste_demand_n') }}">Saisir une demande</a>
            </li>
            <li class="nav-item">
                <a class="nav-link" href="{{ url('liste_demand') }}">Liste des demandes</a>
            </li>
             <li class="nav-item">
    ...
    @extends('layout.chef_bureau.footer')
</body>

</html>
<script src="https://cdn.jsdelivr.net/npm/bootstrap@5.<script src="https://cdn.jsdelivr.net/npm/bootstrap@5.3.2/dist/js/bootstrap.bundle.min.js" integrity="sha384-C6RzsynM9kWDrMNeT87bh95OGNyZPhcTNXj1NW7RuBCsyN/o0jlpcV8Qyq46cDfL" crossorigin="anonymous"></script>3.0/dist/js/bootstrap.bundle.min.js" integrity="sha384-C6RzsynM9kWDrMNeT87bh95OGNyZPhcTNXj1NW7RuBCsyN/o0jlpcV8Qyq46cDfL" crossorigin="anonymous"></script>