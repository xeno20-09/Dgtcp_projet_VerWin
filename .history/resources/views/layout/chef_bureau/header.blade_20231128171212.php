             ...
             <li class="nav-item">
                ...
                <div class="dropdown">
                    ...
                    <ul class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                      <li><a class="dropdown-item" href="#">Etats sur les devises</a></li>
                      <li><a class="dropdown-item" href="#">Etats sur les pays</a></li>
                      <li><a class="dropdown-item" href="#">Etats sur les sociétés</a></li>
                    </ul>
                  </div>
