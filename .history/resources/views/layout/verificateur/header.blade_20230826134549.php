            ...
            <div class="container-fluid">
                ...
                <div class="collapse navbar-collapse" id="navbarColor01">
                    <ul class="navbar-nav me-auto">
                        ...
                        <li class="nav-item">
                            <a class="nav-link" href="{{ url('ListeDemandesN') }}">Saisir une demande</a>
                        </li>
                        ...
                        <li class="nav-item dropdown">
                            ...
                            <div class="dropdown-menu dropdown-menu-end" aria-labelledby="navbarDropdown">
                                ...
                                <a class="dropdown-item" href="{{ action([\App\Http\Controllers\ControllerVerificateur::class, 'get_list_ask']) }}">
        ...
        <li class="nav-item">
          <a class="nav-link" href="#">About</a>
                    ...
                    <form class="d-flex flex-row gap-3" style="width: 32%;position: relative;left: 120px;top: 72px;"
                        action="{{ route('get_search_ask_verificateur', $item->id) }}" method="GET">
