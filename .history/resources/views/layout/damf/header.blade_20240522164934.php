            ...
            <div class="container-fluid">
                ...
                <div class="collapse navbar-collapse" id="navbarColor01">
                    ...
                    <form class="d-flex flex-row gap-3" style="width: 32%;position: relative;left: 120px;top: 72px;"
                        action="{{ route('info.search.d', $item->id) }}" method="GET">
                ...
                <li style="list-style-type: none;" class="nav-item">
                    ...
                    <span class="badge rounded-pill badge-notification bg-danger blink-animation"
    ...
    <div class="container">
        <ul class="nav nav-pills mt-3">
            ...
            <li class="nav-item">
                ...
                --}} <a class="nav-link" href="{{ url('liste_dmd_n') }}">Approuvé une demande</a>
            </li>
            <li class="nav-item">
                {{-- <a class="nav-link" href="{{ url('liste_dmd_n') }}">Saisir une demande</a>
                --}} <a class="nav-link" href="{{ url('liste_dmd_n') }}">Liste des demandes vu</a>
            </li>
            {{-- <li class="nav-item">
