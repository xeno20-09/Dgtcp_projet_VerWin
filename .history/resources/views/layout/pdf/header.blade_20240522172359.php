...
{{--         <img style="height:50px;" src="{{ asset('images/whiteOfficialLogo.png') }}" alt="Mon Image">
    ...
    <img src="https://i.ibb.co/Sr7WJ3w/iso.jpg" alt="iso" style="height:50px;margin-left:150px;"></a>
    <img src="https://i.ibb.co/sJN33Sz/logo-DGTCP-2-blanc.png" 
                alt="logo-DGTCP-2-blanc" style="height:50px;margin-left:200px;" ></a>
    <img src="https://i.ibb.co/0By00BM/white-Official-Logo.png"
