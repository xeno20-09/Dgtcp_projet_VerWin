...
<body>
    <div style="display:flex;flex-direction:row;justify-content:space-between;">
        ...
        <a href="https://ibb.co/ChhCJZg"><img src="https://i.ibb.co/FggZsM2/logo-DGTCP-2-blanc-removebg-preview.png" alt="logo-DGTCP-2-blanc-removebg-preview" border="0"></a>
<a href="https://ibb.co/BGzKndf"><img src="https://i.ibb.co/8bK4YTm/white-Official-Logo-removebg-preview.png" alt="white-Official-Logo-removebg-preview" border="0"></a>


        <img src="https://i.ibb.co/0By00BM/white-Official-Logo.png" alt="white-Official-Logo" style="height:50px;">

        <img src="https://i.ibb.co/Sr7WJ3w/iso.jpg" alt="iso" style="height:50px;margin-left:150px;">
        <img src="https://i.ibb.co/sJN33Sz/logo-DGTCP-2-blanc.png" alt="logo-DGTCP-2-blanc"
            style="height:50px;margin-left:200px;">
