...
{{--         <img style="height:50px;" src="{{ asset('images/whiteOfficialLogo.png') }}" alt="Mon Image">
        ...
        <a href="https://ibb.co/gVFH6RZ"><img src="https://i.ibb.co/Sr7WJ3w/iso.jpg" alt="iso" style="height:50px;margin-left:150px;"></a>
        <a href="https://ibb.co/Z1FTTs7"><img src="https://i.ibb.co/sJN33Sz/logo-DGTCP-2-blanc.png" 
                alt="logo-DGTCP-2-blanc" style="height:50px;margin-left:200px;" ></a>
        <a href="https://ibb.co/5YhQQY8"><img src="https://i.ibb.co/0By00BM/white-Official-Logo.png"
                alt="white-Official-Logo"  style="height:50px;"></a>
