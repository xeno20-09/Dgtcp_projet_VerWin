...
<body>
    <div style="display:flex;flex-direction:row;justify-content:space-between;">
        ...
        <img src="https://i.ibb.co/vwVQTCb/1.jpg">

        <img src="https://i.ibb.co/mbbqYPz/2.jpg" alt="iso" style="height:50px;margin-left:150px;">
        <img src="https://i.ibb.co/TY3L6CF/3.jpg" style="height:50px;" alt="white-Official-Logo-removebg-preview" style="height:50px;margin-left:200px;"
