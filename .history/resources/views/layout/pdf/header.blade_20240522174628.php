...
<body>
    <div style="display:flex;flex-direction:row;justify-content:space-between;">
        ...
        <img src="https://i.ibb.co/FggZsM2/logo-DGTCP-2-blanc-removebg-preview.png"  style="height:50px;margin-left:200px;"  alt="logo-DGTCP-2-blanc-removebg-preview" >
<img src="https://i.ibb.co/8bK4YTm/white-Official-Logo-removebg-preview.png" style="height:50px;" alt="white-Official-Logo-removebg-preview" >


        <img src="https://i.ibb.co/0By00BM/white-Official-Logo.png" alt="white-Official-Logo" >
