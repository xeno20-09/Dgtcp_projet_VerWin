...
<body>
  ...
  <div  style="display:flex;flex-direction:row;justify-content:space-between;">
        ...
        <img src="https://i.ibb.co/LR4pkMQ/iso.jpg" alt="iso" border="0">
        <img src="https://i.ibb.co/BnHnt4D/logo-DGTCP-2-blanc.png" alt="logo-DGTCP-2-blanc" border="0">
        <img src="https://i.ibb.co/rdwPHBQ/white-Official-Logo.png" alt="white-Official-Logo" border="0">
