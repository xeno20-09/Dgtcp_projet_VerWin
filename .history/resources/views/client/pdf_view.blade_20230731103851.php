        ...
        <div class="col-md-12">
            ...
            <div style="max-width: fit-content;" class="card mb-3 d-flex flex-row">
                ...
                <table class="table table-bordered">
                    ...
                    <li class="list-group-item">Numéro de compte du client: </li>
                    <li class="list-group-item">Nom du beneficiaire: </li>
                    <li class="list-group-item">Prenom du beneficiaire: </li>
