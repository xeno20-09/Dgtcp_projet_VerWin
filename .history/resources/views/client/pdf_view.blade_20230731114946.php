...
<body>
  ...
  <div  style="display:flex;flex-direction:row;justify-content:space-between;">
          ...
          <img src="https://i.goopics.net/bxxd94.png" style="height:50px;margin-left:0px;" alt="" />
      
      
        <img src="https://i.goopics.net/p4j8zd.jpg"  style="height:50px;margin-left:0px;" alt="" />
