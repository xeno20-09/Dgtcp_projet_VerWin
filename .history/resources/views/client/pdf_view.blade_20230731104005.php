        ...
        <div class="col-md-12">
            ...
            <div style="max-width: fit-content;" class="card mb-3 d-flex flex-row">
                ...
                <table class="table table-bordered">
                    ...
                    <li class="list-group-item">Banque du beneficiaire:</li>
                    <li class="list-group-item">Pays du beneficiaire: </li>
                    <li class="list-group-item">Numero de compte du beneficiaire: </li>
                    <!-- Ajoutez ici les autres lignes pour les autres champs du formulaire -->
                </table>
            </div>
            @endforeach
