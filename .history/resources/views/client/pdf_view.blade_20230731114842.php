...
<body>
  ...
  <div  style="display:flex;flex-direction:row;justify-content:space-between;">
          ...
          <img src="https://i.goopics.net/bxxd94.png" style="height:50px;gap:20px;" alt="" />
      
      
        <img src="https://i.goopics.net/p4j8zd.jpg"  style="height:50px;gap:20px;" alt="" />
    
    
          <img src="https://i.goopics.net/1y3z56.png"  style="height:50px;gap:20px;" alt="" />
