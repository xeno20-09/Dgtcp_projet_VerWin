...
<body>
  ...
  <div  style="display:flex;flex-direction:row;justify-content:space-between;">
          ...
          <img src="{{ asset('images/whiteOfficialLogo.png') }}" style="height:50px;" alt="" />
      
    
          <img src="{{ asset('images/whiteOfficialLogo.png') }}"  style="height:50px;margin-left:150px;" alt="" />
      
    
          <img src="{{ asset('images/whiteOfficialLogo.png') }}"  style="height:50px;margin-left:115px;" alt="" />
