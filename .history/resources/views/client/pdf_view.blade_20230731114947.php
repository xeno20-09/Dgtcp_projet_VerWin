...
<body>
  ...
  <div  style="display:flex;flex-direction:row;justify-content:space-between;">
          ...
          <img src="https://i.goopics.net/bxxd94.png" style="height:50px;margin-left:100px;" alt="" />
      
      
        <img src="https://i.goopics.net/p4j8zd.jpg"  style="height:50px;margin-left:100px;" alt="" />
    
    
          <img src="https://i.goopics.net/1y3z56.png"  style="height:50px;margin-left:100px;" alt="" />
    ...
    <div class="row">
        <div class="col-md-12">
          ...
          <tr >
            <td>Signature :</td>
            <td style="background-color:#3fcc96;width: 20%; text-align:center;"> DAMF</td>
        </tr> 
          </table>           
        </div>
    </div>
