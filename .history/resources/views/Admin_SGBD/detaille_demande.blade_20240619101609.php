    ...
    <div class="container">
        <h1 style="text-align: center;">
            {{--         @foreach ($user as $item)
                <a class="nav-link" href="#">  {{ $item['firstname'] }} {{ $item['lastname'] }}   <span class="badge rounded-pill badge-notification bg-danger"
                ...
                <tbody>
                    @foreach ($demande as $item)
                        <tr>
                            ...
                            @php
                                $status_dmd = ' ';
                                if ($item['vu_secret'] == 1 && $item['vu_verifi'] == 0 && $item['vu_chef_division'] == 0 && $item['vu_chef_bureau'] == 0 && $item['vu_damf'] == 0) {
                                    $position = 'Vérificateur';
                                    echo "<td>$position</td>";
                                }
                                if ($item['vu_secret'] == 1 && $item['vu_verifi'] == 1 && $item['vu_chef_division'] == 0 && $item['vu_chef_bureau'] == 0 && $item['vu_damf'] == 0) {
                                    $position = 'Chef division';
                                    echo "<td>$position</td>";
                                }
                                if ($item['vu_secret'] == 1 && $item['vu_verifi'] == 1 && $item['vu_chef_division'] == 1 && $item['vu_chef_bureau'] == 0 && $item['vu_damf'] == 0) {
                                    $position = 'Chef service';
                                    echo "<td>$position</td>";
                                }
                                if ($item['vu_secret'] == 1 && $item['vu_verifi'] == 1 && $item['vu_chef_division'] == 1 && $item['vu_chef_bureau'] == 1 && $item['vu_damf'] == 0) {
                                    $position = 'Directeur';
                                    echo "<td>$position</td>";
                                }
                                if ($item['vu_secret'] == 1 && $item['vu_verifi'] == 1 && $item['vu_chef_division'] == 1 && $item['vu_chef_bureau'] == 1 && $item['vu_damf'] == 1) {
