    ...
    <div class="row">
      <div class="col">
        <div class="form-group">
          ...
          <input value="{{ $item_c['firstname'] }} {{ $item_c['lastname'] }}" name="name" type="text" class="form-control" id="" placeholder="" disabled>
        </div>
      </div>
        ...
        <div class="form-group">
          <label for="" class="form-label mt-4">Poste:</label>
           <select value="{{ $item_c->poste}}" name="poste" class="form-select" id="exampleDisabledSelect1">
            ...
            <option class="">Chef service</option>
      ...
      <div class="col">
        <div class="form-group">
          ...
          <input value="{{ $item_c->email}}" name="Email" type="text" class="form-control" id="" placeholder="" disabled>
        </div>
      </div>
      <div class="col">
        <div class="form-group">
          <label for="" class="form-label mt-4">Inscrit le:</label>
          <input value="{{ $item_c->created_at}}" name="date" type="text" class="form-control" id="" placeholder="" disabled>
