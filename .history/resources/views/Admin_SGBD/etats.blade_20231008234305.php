...
@php
    ...
    // Si la devise n'existe pas dans le tableau de récapitulation, l'ajouter avec le montant actuel
    if (!isset($recap[$devise])) {
        $recap[$devise] = $montant;
    } else {
        // Sinon, ajouter le montant à la devise existante
        $recap[$devise] += $montant;
    }
@endphp
    {{ $recap[$devise] }}     {{ $dev['montant'] }}
