...
<div class="container">
    <h1 style="text-align: center;">
        ...
        @endforeachù    <h1 style="text-align: center;">
            @foreach ($user as $item)
        ...
        <div class="row">
            <div class="col">
                <div class="form-group">
                    ...
                    <input value="{{ $item_c['firstname'] }} {{ $item_c['lastname'] }}" name="name" type="text"
            ...
            <div class="col">
                <div class="form-group">
                    ...
                    <input value="{{ $item_c->email }}" name="Email" type="text" class="form-control" id=""
            ...
            <div class="col">
                <div class="form-group">
                    ...
                    <input value="{{ $item_c->created_at }}" name="date" type="text" class="form-control" id=""
                        placeholder="" disabled>
