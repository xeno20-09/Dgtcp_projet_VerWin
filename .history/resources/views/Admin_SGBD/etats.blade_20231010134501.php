...
<div class="container">
    ...
    <form action="{{ route('listedmd') }}" method="post" class="mb-4">
        ...
        <div class="row">
            ...
            <div class="col">
                <button onclick="test1()" class="btn btn-outline mt-4" type="submit"><i class="fas fa-search" style="font-size: 25px;"></i></button>
            </div>
        </div>
    </form>
    ...
    <form action="{{ route('laliste') }}" method="post">
        ...
        <div class="row">
            ...
            <div class="col">
                <button onclick="test2()" class="btn btn-outline mt-4" type="submit"><i class="fas fa-search" style="font-size: 25px;"></i></button>
            </div>
        </div>
    </form>
<br><br>
