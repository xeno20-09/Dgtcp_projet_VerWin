...
<br><br>
    <div class="row">
        <div class="col-md-4">
            <a href=""><button class="btn btn-primary">Situation sur les devises</button></a>
        </div>
        <div class="col-md-4">
            <a href=""><button class="btn btn-primary">Situation sur les pays</button></a>
        </div>
        <div class="col-md-4">
            <a href=""><button class="btn btn-primary">Situation sur les entreprises</button></a>
        </div>
