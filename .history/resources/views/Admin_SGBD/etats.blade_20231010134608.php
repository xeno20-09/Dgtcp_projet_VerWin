        ...
        <div class="row">
            <div class="col">
                <div class="form-group">
                    ...
                    <input value="" name="fdate2" type="dat" class="form-control" id="fdate2">
                </div>
            </div>
            <div class="col">
                <div class="form-group">
                    <label for="sdate2" class="form-label">Date de fin</label>
                    <input value="{{ $date }}" name="sdate" type="date" class="form-control" id="sdate2">
                </div>
            </div>
            <div class="col">
                <div class="form-group">
            ...
            <div class="col">
                <div class="form-group">
                    ...
                    <select name="devis" class="form-select" id="devise">
