            ...
            <div class="row">
                ...
                <div class="col">
                    <div class="form-group">
                        ...
                        <input value="{{ $date }}" name="sdate" type="date" class="form-control"
                            id="sdate">
                    </div>
                </div>
                <div class="col">
                ...
                <div class="col">
                    <button class="btn btn-outline mt-4" type="submit"><i class="fas fa-search"
            ...
            <div class="row">
                ...
                <div class="col">
                    <div class="form-group">
                        ...
                        <input value="{{ $date }}" name="sdate2" type="date" class="form-control"
                            id="sdate2">
                    </div>
                </div>
                <div class="col">
