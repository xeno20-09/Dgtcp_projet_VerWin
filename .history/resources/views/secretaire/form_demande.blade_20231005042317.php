...
<div id="physique">
    ...
    <div class="row">
        ...
        <script>
        var selectedDevise = document.getElementById('currency_from_p').value;
        var devises = @json($devise);
        
        // Parcourir les devises et effectuer la comparaison
        for (const devise of devises) {
            if (selectedDevise === devise.devise) {
                // La devise sélectionnée correspond à celle de $devise->devise
                // Vous pouvez effectuer ici l'action souhaitée
                console.log('Devise sélectionnée : ' + selectedDevise);
