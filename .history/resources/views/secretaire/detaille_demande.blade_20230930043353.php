                ...
                @foreach ($demande as $item)
                    <tr>
                        ...
                        @php
                            ...
                            elseif($item['vu_secret']==1)&& ($item['vu_verifi']==1)&&($item['vu_chef_division']==0) && ($item['vu_chef_bureau']==0) && ($item['vu_damf']==0){
                                $position="Chef division";
                            }
                            elseif($item['vu_secret']==1)&& ($item['vu_verifi']==1)&&($item['vu_chef_division']==1) && ($item['vu_chef_bureau']==0) && ($item['vu_damf']==0){
                                $position="Chef service";
                            }
                            elseif($item['vu_secret']==1)&& ($item['vu_verifi']==1)&&($item['vu_chef_division']==1) && ($item['vu_chef_bureau']==1) && ($item['vu_damf']==0){
                                $position="Directeur";
                            }
                            elseif($item['vu_secret']==1)&& ($item['vu_verifi']==1)&&($item['vu_chef_division']==1) && ($item['vu_chef_bureau']==1) && ($item['vu_damf']==1){
                                echo"<td>{{ $item['status_dmd'] }}
                                    </td>";
                            }
                        @endphp
