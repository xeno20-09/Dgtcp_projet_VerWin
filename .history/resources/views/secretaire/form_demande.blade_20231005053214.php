...
<script>
    $(document).ready(function() {
        // Sélectionnez l'élément avec l'ID 'currency_from_p'
        $('#currency_from_p').on('blur', function() {
            // Récupérez la valeur saisie dans le champ 'currency_from_p'
            var monnaie = $(this).val();

            // Vérifiez si le champ 'currency_from_p' n'est pas vide
            if (monnaie !== '') {
                // Effectuez une requête AJAX vers l'URL '/get-devis' définie dans votre route Laravel
                $.ajax({
                    type: 'POST', // Utilisez une requête POST pour envoyer des données au serveur
                    ...
                    success: function(data) {
                        ...
                        // Mettez à jour le champ 'valeur_p' avec la valeur récupérée dans la réponse JSON
