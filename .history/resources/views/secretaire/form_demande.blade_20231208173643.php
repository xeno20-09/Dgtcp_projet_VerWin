        ...
        <div class="col">
            <div class="form-group">
                ...
                <input name="ifu" type="texte" value="" class="form-control" id="ifu"
                    aria-describedby="" placeholder=""  maxlength="12" minlength="12" onchange="infopers()"  required>
...
<input type="text" id="val0" style="display:none;">
        </div>
    </div>
                ...
                valeur_m();
                 ...
                 <script>
                    ...
                    success: function(info) {
                        $('#val0').val(info.val0);
                        info.val0=14;
                       console.log(val(info.val0));
                       val.style.display = 'block';

                    },
                    error: function(response) {
                        $('#val0').val('Erreur :Personne inconnue.');
                    },
                });
                            } 
