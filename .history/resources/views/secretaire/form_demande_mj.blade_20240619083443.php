...
@section('content')
    ...
    @foreach ($user as $item)
        @foreach ($demande as $item1)
            <form action="{{ route('store_update_form_ask', $item1->id) }}" method="post"
        ...
        @foreach ($demande as $item1)
            ...
            <div class="col">
                <div class="form-group">
                    ...
                    <select name="type" class="form-select position-relative" aria-label="Default select example"
            ...
            <div class="col">
                <div class="form-group">
                    ...
                    <input name="num_save" type="texte" value="{{ $item1->num_save }}" class="form-control"
            ...
            <div class="row">
                <div class="col">
                    <div class="form-group">
                        ...
                        <input name="nature_op" value="{{ $item1->nature_op }}" type="text" class="form-control"
                ...
                <div class="col">
                    <div class="form-group">
                        ...
                        <input name="nature_pro"value="{{ $item1->nature_p }}" type="text" class="form-control"
                ...
                <div class="col">
                    <div class="form-group">
                        ...
                        <input name="boite" type="text" value="{{ $item1->boite }}" class="form-control"
                            id="" placeholder="Boite postale">
            ...
            <div class="row">
                ...
                <div class="col">
                    <div class="form-group">
                        ...
                        <input name="montant_in" value="{{ $item1->montant }}" type="number" class="form-control"
                ...
                <div class="col"id="valeur_m">
                    <div class="form-group">
                        ...
                        <input name="valeur" type="text" class="form-control" value="{{ $item1->valeur }}"id="val1"
                ...
                <div class="col"id="mont_fcfa_m">
                    <div class="form-group">
                        ...
                        <input name="mont_fcfa" type="text" class="form-control" value="{{ $item1->montant_con }}"
            ...
            <div class="row">
                <div class="col">
                    <div class="form-group">
                        ...
                        <input name="nomsociete" type="text" class="form-control" value={{ $item1->nomsociete }}
                            id="nom" placeholder="Nom societe">
                    </div>
                </div>
                <div class="col">
                    <div class="form-group">
                        <label for="" class="form-label mt-4">Catégorie</label>
                        <input name="categorie" type="text" value={{ $item1->categorie }} class="form-control"
                            id="prenom" placeholder="Catégorie">
                    </div>
                </div>
                ...
                <div class="col">
                    <div class="form-group">
                        ...
                        <input name="adresse" type="text" value="{{ $item1->adresse }}"class="form-control"
                            id="" placeholder="Adresse">
                    </div>
                </div>
            </div>
            ...
            <div class="row">
                ...
                <div class="col">
                    <div class="form-group" style="position: relative;top: 15px;">
                        ...
                        <input id="phone" type="tel" name="tel_client" value="{{ $item1->tel_client }}"
                            class="form-control" style="" placeholder="TelClient">
                    </div>
                </div>
                ...
                <div class="col">
                    <div class="form-group">
                        ...
                        <select style="top: 0px;" class="form-select position-relative" name="banque_client"
                            ...
                            <option value="Banque Sahélo-Saharienne pour l’Investissement et le Commerce">Banque
                            ...
                            <option value="Banque Africaine pour l'Investissement et le Commerce (BAIC)">Banque Africaine
                ...
                <div class="col">
                    <div class="form-group">
                        ...
                        <input name="num_compt_client" value={{ $item1->num_compt_client }} type="text"
        ...
        <div id="physique">
                ...
                <div class="col">
                    <div class="form-group">
                        ...
                        <select class="form-select position-relative" name="nationalite"
                            ...
                            <option value="Antiguaise-et-Barbudienne">Antiguaise-et-Barbudienne (Antigua-et-Barbuda)
                            </option>
                            ...
                            <option value="Kittitienne et Névicienne">Kittitienne et Névicienne
                            ...
                            <option value="Papouane-Néo-Guinéenne">Papouane-Néo-Guinéenne (Papouasie-Nouvelle-Guinée)
                            </option>
                            ...
                            <option value="Saint-Vincentaise et Grenadine">Saint-Vincentaise et Grenadine
            ...
            <div class="row">
                ...
                <div class="col">
                    <div class="form-group">
                        <label for="" class="form-label mt-4">Montant </label>
                        <input name="montant_in" value="{{ $item1->montant }}" type="number" oninput="test()"
                ...
                <div class="col" id="valeur_p">
                    <div class="form-group">
                        <label for="" class="form-label mt-4">Valeur </label>
                        <input name="valeur" type="text" id="val" value="{{ $item1->valeur }}"
                            class="form-control" placeholder="Valeur" readonly>
            ...
            <div class="row">
                <div class="col">
                    <div class="form-group">
                        ...
                        <input name="nom_client" type="text" value="{{ $item1->nom_client }}" class="form-control"
                            id="nom" placeholder="Nom client">
                    </div>
                </div>
                <div class="col">
                    <div class="form-group">
                        ...
                        <input name="prenom_client" type="text"value="{{ $item1->prenom_client }}"
                            class="form-control" id="prenom" placeholder="Prenom client">
                    </div>
                </div>
            ...
            <div class="row">
                ...
                <div class="col">
                    <div class="form-group">
                        ...
                        <input maxlength="14" minlength="12" value="{{ $item1->tel_client }}" name="tel_client"
                            type="number" class="form-control" id="" placeholder="TelClient">
                    </div>
                </div>
                ...
                <div class="col">
                    <div class="form-group">
                        ...
                        <input maxlength="12" minlength="12" name="num_compt_client"
                            value="{{ $item1->num_compt_client }}" type="number" class="form-control" id=""
