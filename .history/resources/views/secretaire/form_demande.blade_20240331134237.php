...
<form action="{{ route('store_form_ask', $item->id) }}" method="post" class="card-body cardbody-color p-lg-5">
    ...
    <div class="row">
        ...
        <button type="button" id="press" style="display: none;">test</button>
        ...
        <div class="col">
            <div class="form-group">
                ...
                <input name="ifu" type="texte" value="" class="form-control" id="ifu" aria-describedby="" placeholder=""
                    maxlength="13" minlength="12" onchange="infopers()" required>
        ...
        if (ifutake !== 'null') {
            $.ajax({
               ...
               /*      val.style.display = 'block';
                ...
                error: function (info) {
                    if(info){
                        $('#press').val('Erreur : devise introuvable.');
                    }
...
<script>
    $('#press').on("click" ,function() {   toastr.options = {
      "closeButton": false,
      "debug": false,
      "newestOnTop": false,
      "progressBar": true,
