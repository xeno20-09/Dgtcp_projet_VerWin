...
<div id="physique">
    ...
    <div class="row">
        ...
        <script>
      var choix = document.getElementById('currency_from_p').value ;
...
function valeur_p() {
        ...
        var devises = @json($devise); // Convertir la variable PHP $devise en JSON
    
        // Maintenant, vous pouvez utiliser la variable 'devises' dans votre script JavaScript
        console.log(devises);
    
        // Parcourir les devises et effectuer des opérations JavaScript sur elles
        devises.forEach(function(devise) {
            // Faites quelque chose avec chaque élément de la table 'devise'
            if(devises.nom=devises)
            console.log('Nom de la devise : ' + devise.nom);
            console.log('Valeur de la devise : ' + devise.valeur);
        });
