      ...
      {{--   @foreach ($user as $item)
        ...
        <div class="col">
            <div class="form-group">
                ...
                aria-label="Default select example" value="{{ $item1->type_prs }}" id="type" onchange="toggleFields()" name="type_prs" required>
...
<div id="physique">
    ...
    <div class="row">
        ...
        <div class="col">
            <div class="form-group">
                <label for="" class="form-label mt-4">Montant </label>
                <input name="montant_in" value={{ $item1->montant_in }} type="number" oninput="test()" class="form-control"  id="montant_in" placeholder="Montant ">
            </div>
        </div>
    ...
    <div class="row">
        <div class="col">
            <div class="form-group">
                ...
                <input name="nom_client" type="text" value={{ $item1->nomclient }} class="form-control" id="nom" placeholder="Nom client">
            </div>
        </div>
        <div class="col">
            <div class="form-group">
                <label for="" class="form-label mt-4">Prenom client</label>
                <input name="prenom_client" type="text"value={{ $item1->prenomclient }}  class="form-control" id="prenom"
        ...
        <div class="col">
            <div class="form-group">
                ...
                <input name="profess_client" type="text"value={{ $item1->profclient }}  class="form-control" id=""
