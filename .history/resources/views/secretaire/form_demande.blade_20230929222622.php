...
@section('content')
    ...
    <div class="row">
        ...
        <div class="col">
         ...
         <input type='hidden' name='codecountry'id="codcountry" value="">
         <input type='hidden' name='namcountry'id="namecountry" value="">
...
document.addEventListener("DOMContentLoaded", function() {
 ...
 /*    window.intlTelInput(input, {
  ...
  utilsScript: "/intl-tel-input/js/utils.js?1695806485509"
    ...
    // Créez une instance de la bibliothèque intl-tel-input
   // var iti = window.intlTelInput(input);
    // Récupérez le code du pays sélectionné
    var countryData = iti.getSelectedCountryData();    
    // Définissez la valeur du champ de formulaire caché
    var namecountry = document.querySelector("input[name='namcountry']");
    
    namcountry.value = aaa;
    var codecountry = document.querySelector("input[name='codecountry']");
    
    codecountry.value = 555;
