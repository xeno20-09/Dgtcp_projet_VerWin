      ...
      {{--   @foreach ($user as $item)
        ...
        <div class="col">
            <div class="form-group">
                ...
                <input name="type_prs" type="texte" value="" class="form-control" id="ifu"
                aria-describedby="" placeholder="" id="type" onchange="toggleFields()" name="type_prs"  value="null" required>
