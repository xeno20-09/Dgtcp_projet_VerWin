...
function valeur_p() {
        ...
        var devises = @json($dev); // Convertir la variable PHP $dev en JSON

// Parcourir les devises et effectuer des opérations JavaScript sur elles
devises.forEach(function(deviseItem) {
    // Faites quelque chose avec chaque élément de la table 'devise'
    if (deviseItem.nom == devise) {
        console.log('Valeur de la devise : ' + deviseItem.valeur);
    }
});
