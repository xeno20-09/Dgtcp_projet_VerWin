    ...
    <div class="row">
        ...
        <div class="col">
            <div class="form-group">
                ...
                <input name="categorie" type="text" class="form-control" id="prenom_id_m"
...
var prenom_id_m = document.getElementById('prenom_id_m').value;
var boite_id_m = document.getElementById('boite_id_m').value;
var profess_id_m = document.getElementById('profess_id_m').value;
var nationalite_id_m = document.getElementById('nationalite_id_m').value;
