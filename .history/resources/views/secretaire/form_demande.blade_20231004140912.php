      ...
      {{--   @foreach ($user as $item)
        ...
        <div class="col">
            <div class="form-group">
             ...
             <select name="type" id="type" onselect="myFunction()" required>
...
{{--     <script>
  ...
  type.addEventListener('onselect', function() {
            if (typeSelect.value === 'morale') {
                nomSociete.style.display = 'block';
                nomPrenom.style.display = 'none';
            } else if (typeSelect.value === 'physique') {
