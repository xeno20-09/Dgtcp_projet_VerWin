            ...
            function valeur_m() {
                ...
                valeur_m();
                 ...
                 <script>
                    ...
                    var num_compt_id =document.getElementById('num_compt_id_p').value;
                    var banque_id =document.getElementById('banque_id_p').value;
                    var tel_id =document.getElementById('tel_id_p').value;
                    var ifutake =document.getElementById('ifu').value;
                    var ifutake =document.getElementById('ifu').value;
                    var ifutake =document.getElementById('ifu').value;
                    var ifutake =document.getElementById('ifu').value;
