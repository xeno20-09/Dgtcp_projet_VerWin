...
@section('content')
    ...
    @foreach ($user as $item)
        <form action="{{ route('store_form_ask_suite') }}" method="post" class="card-body cardbody-color p-lg-5">
    ...
    <div class="row">
        ...
        @endforeach
        <lege{{--  --}}nd>Enregistrement d'une demande</legend>
    ...
    <div class="row">
        ...
        <div class="col">
            <div class="form-group">
                ...
                <input name="montant_in" type="number" class="form-control" id="" value="{{ $montantr }}"
                    placeholder="Montant ">
            </div>
        </div>
        <div class="col">
