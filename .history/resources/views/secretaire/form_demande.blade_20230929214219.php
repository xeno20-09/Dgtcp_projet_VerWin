...
@section('content')
    ...
    <div class="row">
        ...
        <div class="col">
         ...
         <input id="phone" type="tel" name="tel_client" class="form-control"  placeholder="TelClient">
         <input type='hidden' name='u'id="p" value="">
...
<option value="Coris-Bank Bénin">Coris-Bank Bénin</option>
    ...
    <script>
        $(document).ready(function() {
            $("#phone").intlTelInput({
                initialCountry: "auto",
                preferredCountries: ["us", "fr", "gb", "ca"],
                separateDialCode: true,
                utilsScript: "https://cdnjs.cloudflare.com/ajax/libs/intl-tel-input/17.0.12/js/utils.js"
            });
    
            $("form").submit(function(event) {
                // Empêchez la soumission du formulaire par défaut pour le traitement côté serveur
                event.preventDefault();
    
                // Récupérez le code pays sélectionné
                var countryCode = $("#phone").intlTelInput("preferredCountries").iso2;
    
                // Affichez le code pays dans la console (à des fins de démonstration)
                console.log("Code pays sélectionné : " + countryCode);
    
                // Vous pouvez maintenant envoyer le code pays au serveur via une requête AJAX ou un champ de formulaire caché
                // Exemple avec AJAX :
                // $.ajax({
                //     type: "POST",
                //     url: "traitement.php",
                //     data: { phone: $("#phone").val(), countryCode: countryCode },
