...
<div id="morale">
    ...
    <div class="row">
        ...
        <div class="col">
            <div class="form-group">
                ...
                <input name="montant_in" value={{ $item1->montant_in }} type="number" class="form-control" oninput="test1()" id="montant_in_m" placeholder="Montant ">
            </div>
        </div>
    ...
    <div class="row">
        <div class="col">
            <div class="form-group">
                ...
                <input name="nomsociete" type="text" class="form-control" value={{ $item1->nonsociete }} id="nom" placeholder="Nom societe">
            </div>
        </div>
        <div class="col">
            <div class="form-group">
  ...
  {{--      <div class="col">
        ...
        <div class="col">
            <div class="form-group" style="position: relative;top: 15px;">
                   <p>Entrez votre numéro de téléphone:</p>
         <input id="phone" type="tel" name="tel_client" value={{ $item1->numero }} class="form-control" style=""  placeholder="TelClient">
