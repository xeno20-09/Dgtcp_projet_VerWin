...
@section('content')
    ...
    <div>
      ...
      <button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#myModal-{{ $item1->id }}">
         <span class="fa-stack">
                <i class="fa fa-square fa-stack-2x"></i>
                <i class="fas fa-pen fa-stack-1x fa-inverse"></i>
            </span>
        ...
        <!-- Le modal -->
        <div class="modal fade" id="myModal-{{ $item1->id }}" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">            <div class="modal-dialog">
                        ...
                        <div class="row">
                            ...
                            <div class="col">
                                <div class="form-group">
                                    <select style="top: 56px;" class="form-select position-relative" name='currency_from'
                                        ...
                                        <option value="{{ $devise }}"
                                            @if (Request::get('currency_from') == $devise) selected @endif>
                                            {{ $devise }}</option>
                                        <option value="AUD" @if (Request::get('currency_from') == 'AUD') selected @endif>Australia
                                            Dollar</option>
                                        <option value="EUR" @if (Request::get('currency_from') == 'EUR') selected @endif>Euro
                                        </option>
                                        <option value="GBP" @if (Request::get('currency_from') == 'GBP') selected @endif>Great
                                            Britain Pound</option>
                                        <option value="INR" @if (Request::get('currency_from') == 'INR') selected @endif>India
                                            Rupee</option>
                                        <option value="USD" @if (Request::get('currency_from') == 'USD') selected @endif>USA Dollar
                                        </option>
                                    </select>
                                </div>
                            </div>
                            ...
                            <div class="col">
                                <div class="form-group">
                                    ...
                                    <input name="montant_in" type="number" class="form-control" id=""
                                        value="{{ $item1->montant }}" placeholder="Montant ">
                                </div>
                            </div>
                            <div class="col">
                                <div class="form-group">
                                    <select style="top: 56px;" class="form-select position-relative" name='currency_to'
                                        aria-label="Default select example" required>
                                        <option value="XOF" @if (Request::get('currency_to') == 'XOF') selected @endif>Francs CFA
                                        </option>
                                    </select>
                                </div>
                            </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col">
                                <div class="form-group">
                                    ...
                                    <input name="prenom_client" value="{{ $item1->prenom_client }}" type="text"
                            ...
                            <div class="col">
                                <div class="form-group">
                                    ...
                                    <input name="profess_client" value="{{ $item1->profess_client }}" type="text"
                            ...
                            <div class="col">
                                <div class="form-group">
                                    ...
                                    <input maxlength="14" minlength="12" value="{{ $item1->tel_client }}"
                                        name="tel_client" type="text" class="form-control" id=""
                            ...
                            <div class="col">
                                <div class="form-group">
                                    ...
                                    <input maxlength="12" minlength="12" name="num_compt_client"
                                        value="{{ $item1->num_compt_client }}" type="text" class="form-control"
