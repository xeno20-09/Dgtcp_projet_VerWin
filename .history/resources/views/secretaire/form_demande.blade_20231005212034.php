    ...
    <div class="row">
        ...
        <div class="col">
            <div class="form-group">
                ...
                <input name="montant_in" type="number" class="form-control" onchange="test()" id="" placeholder="Montant ">
            </div>
        </div>
...
<script>
    ...
    function test(){
        ...
        const token =document.querySelector('meta[name="crsf-token"]').content
    }
    test();
</script>
     <script>
