    ...
    <div class="row">
        ...
        <div class="col">
            <div class="form-group">
                ...
                <input name="ifu" type="texte" value="" class="form-control" id="ifu" aria-describedby=""
                    placeholder="" maxlength="13" minlength="12" onchange="infopers()" required>
        ...
        <div class="row">
            ...
            <div class="col" id="valeur_p">
                <div class="form-group">
                    ...
                    <input name="valeur" type="text" id="val" class="form-control" placeholder="Valeur"
                        readonly>
        ...
        <div class="row">
            <div class="col">
                <div class="form-group">
                    ...
                    <input name="nom_client" type="text" class="form-control" id="nom_id_p"
        ...
        <div class="row">
            ...
            <div class="col">
                <div class="form-group">
                    ...
                    <input id="banque_id_p" type="texte" name="banque" class="form-control" style=""
                        placeholder="Banque">
                </div>
            </div>
            <div class="col">
    ...
    <div id="morale">
        ...
        <div class="row">
            ...
            <div class="col"id="valeur_m">
                <div class="form-group">
                    <label for="" class="form-label mt-4">Valeur </label>
                    <input name="valeur" type="text" class="form-control" id="val1" placeholder="Valeur"
                        readonly>
                </div>
            </div>
        ...
        <div class="row">
            <div class="col">
                <div class="form-group">
                    ...
                    <input name="nomsociete" type="text" class="form-control" id="nom_id_m"
