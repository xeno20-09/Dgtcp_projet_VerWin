    ...
    <div class="row">
        ...
        <div class="col">
            <div class="form-group">
                ...
                <select name="" id="">
<option value="Bank of Africa Bénin"></option>
<option value="Banque internationale du Bénin"></option>
<option value="Banque de l'habitat du Bénin"></option>
<option value="Ecobank"></option>
<option value="Orabank Bénin"></option>
<option value="United Bank of Africa"></option>
<option value="Diamond Bank"></option>
<option value="Société générale de banques du Bénin"></option>
<option value="Banque Sahélo-Saharienne pour l’Investissement et le Commerce"></option>
<option value="Banque atlantique du Bénin"></option>
<option value="BGFIBank Bénin"></option>
<option value="Afriland first bank benin"></option>
<option value="Banque Africaine pour l'Investissement et le Commerce (BAIC)"></option>
<option value="CBAO surcusale Attijariwafa Bank"></option>
<option value="Coris-Bank Bénin"></option>
