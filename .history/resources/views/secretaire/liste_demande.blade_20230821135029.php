                    ...
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            ...
                            <div class="row">
                                ...
                                <div class="col">
                                    <div class="form-group">
                                        <select style="top: 56px;" class="form-select position-relative"
                                            name='currency_from' aria-label="Default select example" required>
                                            <option value="{{ $devise }}"
                                                @if (Request::get('currency_from') == $devise) selected @endif>
                                                {{ $devise }}</option>
                                            <option value="AUD" @if (Request::get('currency_from') == 'AUD') selected @endif>
                                                Australia
                                                Dollar</option>
                                            ...
                                            <option value="INR" @if (Request::get('currency_from') == 'INR') selected @endif>India
                                                Rupee</option>
                                            <option value="USD" @if (Request::get('currency_from') == 'USD') selected @endif>USA
                                                Dollar
                                            </option>
                                        </select>
                                    </div>
                                ...
                                <div class="col">
                                    <div class="form-group">
                                        <select style="top: 56px;" class="form-select position-relative"
                                            name='currency_to' aria-label="Default select example" required>
                                            <option value="XOF" @if (Request::get('currency_to') == 'XOF') selected @endif>Francs
                                                CFA
                                            </option>
                                        </select>
                                    </div>
