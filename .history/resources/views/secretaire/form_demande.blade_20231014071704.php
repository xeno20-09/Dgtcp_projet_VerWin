    ...
    <div class="row">
        ...
        <div class="col">
            ...
            {{--  @foreach ($listedevis as $name )
             ...
             @endforeach  --}}
             <option value="Dirham des Émirats arabes unis">Dirham des Émirats arabes unis</option>
             <option value="Lek albanais">Lek albanais</option>
             <option value="Dram arménien">Dram arménien</option>
             <option value="Florin antillais néerlandais">Florin antillais néerlandais</option>
             <option value="Kwanza angolais">Kwanza angolais</option>
             <option value="Peso argentin">Peso argentin</option>
             <option value="Dollar australien">Dollar australien</option>
             <option value="Florin arubais">Florin arubais</option>
             <option value="Manat azerbaïdjanais">Manat azerbaïdjanais</option>
             <option value="Mark bosniaque">Mark bosniaque</option>
             <option value="Dollar barbadien">Dollar barbadien</option>
             <option value="Taka bangladais">Taka bangladais</option>
             <option value="Lev bulgare">Lev bulgare</option>
             <option value="Dinar bahreïni">Dinar bahreïni</option>
             <option value="Franc burundais">Franc burundais</option>
             <option value="Dollar bermudien">Dollar bermudien</option>
             <option value="Dollar de Brunei">Dollar de Brunei</option>
             <option value="Boliviano bolivien">Boliviano bolivien</option>
             <option value="Réal brésilien">Réal brésilien</option>
             <option value="Dollar bahaméen">Dollar bahaméen</option>
             <option value="Ngultrum bhoutanais">Ngultrum bhoutanais</option>
             <option value="Pula botswanais">Pula botswanais</option>
             <option value="Rouble biélorusse">Rouble biélorusse</option>
             <option value="Dollar bélizien">Dollar bélizien</option>
             ...
             <option value="Peso chilien">Peso chilien</option>
             <option value="Renminbi chinois">Renminbi chinois</option>
             <option value="Peso colombien">Peso colombien</option>
             <option value="Colón costaricien">Colón costaricien</option>
             <option value="Peso cubain">Peso cubain</option>
             <option value="Couronne danoise">Couronne danoise</option>
             <option value="Peso dominicain">Peso dominicain</option>
             <option value="Dinar algérien">Dinar algérien</option>
             <option value="Livre égyptienne">Livre égyptienne</option>
             <option value="Nakfa érythréen">Nakfa érythréen</option>
             <option value="Birr éthiopien">Birr éthiopien</option>
             <option value="Euro">Euro</option>
             <option value="Dollar fidjien">Dollar fidjien</option>
             <option value="Livre des îles Falkland">Livre des îles Falkland</option>
             <option value="Livre sterling">Livre sterling</option>
             <option value="Lari géorgien">Lari géorgien</option>
             <option value="Livre de Guernesey">Livre de Guernesey</option>
             <option value="Cédi ghanéen">Cédi ghanéen</option>
             <option value="Livre de Gibraltar">Livre de Gibraltar</option>
             <option value="Dalasi gambien">Dalasi gambien</option>
             <option value="Franc guinéen">Franc guinéen</option>
             <option value="Quetzal guatémaltèque">Quetzal guatémaltèque</option>
             <option value="Dollar guyanais">Dollar guyanais</option>
             <option value="Dollar de Hong Kong">Dollar de Hong Kong</option>
             <option value="Lempira hondurien">Lempira hondurien</option>
             <option value="Kuna croate">Kuna croate</option>
             <option value="Gourde haïtienne">Gourde haïtienne</option>
             <option value="Forint hongrois">Forint hongrois</option>
             <option value="Roupie indonésienne">Roupie indonésienne</option>
             <option value="Nouveau shekel israélien">Nouveau shekel israélien</option>
             <option value="Livre de l'île de Man">Livre de l'île de Man</option>
             <option value="Roupie indienne">Roupie indienne</option>
             <option value="Dinar irakien">Dinar irakien</option>
             <option value="Rial iranien">Rial iranien</option>
             <option value="Couronne islandaise">Couronne islandaise</option>
             <option value="Livre de Jersey">Livre de Jersey</option>
             <option value="Dollar jamaïcain">Dollar jamaïcain</option>
             <option value="Dinar jordanien">Dinar jordanien</option>
             <option value="Yen japonais">Yen japonais</option>
             <option value="Shilling kényan">Shilling kényan</option>
             <option value="Som kirghize">Som kirghize</option>
             <option value="Riel cambodgien">Riel cambodgien</option>
             <option value="Franc comorien">Franc comorien</option>
             <option value="Won nord-coréen">Won nord-coréen</option>
             <option value="Won sud-coréen">Won sud-coréen</option>
             <option value="Dinar koweïtien">Dinar koweïtien</option>
             <option value="Dollar des îles Caïmans">Dollar des îles Caïmans</option>
             <option value="Tenge kazakh">Tenge kazakh</option>
             <option value="Kip laotien">Kip laotien</option>
             <option value="Livre libanaise">Livre libanaise</option>
             <option value="Roupie sri-lankaise">Roupie sri-lankaise</option>
             <option value="Dollar libérien">Dollar libérien</option>
             <option value="Loti lesothan">Loti lesothan</option>
             <option value="Litas lituanien">Litas lituanien</option>
             <option value="Lats letton">Lats letton</option>
             <option value="Dinar libyen">Dinar libyen</option>
             <option value="Dirham marocain">Dirham marocain</option>
             <option value="Leu moldave">Leu moldave</option>
             <option value="Ariary malgache">Ariary malgache</option>
             <option value="Denar macédonien">Denar macédonien</option>
             <option value="Kyat birman">Kyat birman</option>
             <option value="Tugrik mongol">Tugrik mongol</option>
             <option value="Pataca de Macao">Pataca de Macao</option>
             <option value="Ouguiya mauritanien">Ouguiya mauritanien</option>
             <option value="Roupie mauricienne">Roupie mauricienne</option>
             <option value="Rufiyaa maldivienne">Rufiyaa maldivienne</option>
             <option value="Kwacha malawite">Kwacha malawite</option>
             <option value="Peso mexicain">Peso mexicain</option>
             <option value="Ringgit malais">Ringgit malais</option>
             <option value="Metical mozambicain">Metical mozambicain</option>
             <option value="Dollar namibien">Dollar namibien</option>
             <option value="Naira nigérian">Naira nigérian</option>
             <option value="Córdoba nicaraguayen">Córdoba nicaraguayen</option>
             <option value="Couronne norvégienne">Couronne norvégienne</option>
             <option value="Roupie népalaise">Roupie népalaise</option>
             <option value="Dollar néo-zélandais">Dollar néo-zélandais</option>
             <option value="Rial omanais">Rial omanais</option>
             <option value="Balboa panaméen">Balboa panaméen</option>
             <option value="Nuevo sol péruvien">Nuevo sol péruvien</option>
             <option value="Kina papouan-néo-guinéen">Kina papouan-néo-guinéen</option>
             <option value="Peso philippin">Peso philippin</option>
             <option value="Roupie pakistanaise">Roupie pakistanaise</option>
             <option value="Złoty polonais">Złoty polonais</option>
             <option value="Guaraní paraguayen">Guaraní paraguayen</option>
             <option value="Riyal qatari">Riyal qatari</option>
             <option value="Leu roumain">Leu roumain</option>
             <option value="Dinar serbe">Dinar serbe</option>
             <option value="Rouble russe">Rouble russe</option>
             <option value="Franc rwandais">Franc rwandais</option>
             <option value="Riyal saoudien">Riyal saoudien</option>
             <option value="Dollar des îles Salomon">Dollar des îles Salomon</option>
             <option value="Roupie des Seychelles">Roupie des Seychelles</option>
             <option value="Livre soudanaise">Livre soudanaise</option>
             <option value="Couronne suédoise">Couronne suédoise</option>
             <option value="Dollar de Singapour">Dollar de Singapour</option>
             <option value="Livre de Sainte-Hélène">Livre de Sainte-Hélène</option>
             <option value="Leone sierra-léonais">Leone sierra-léonais</option>
             <option value="Shilling somalien">Shilling somalien</option>
             <option value="Dollar surinamais">Dollar surinamais</option>
             <option value="Dobra santoméen">Dobra santoméen</option>
             <option value="Livre sud-soudanaise">Livre sud-soudanaise</option>
             <option value="Livre syrienne">Livre syrienne</option>
             <option value="Lilangeni swazi">Lilangeni swazi</option>
             <option value="Baht thaïlandais">Baht thaïlandais</option>
             <option value="Somoni tadjik">Somoni tadjik</option>
             <option value="Manat turkmène">Manat turkmène</option>
             <option value="Dinar tunisien">Dinar tunisien</option>
             <option value="Pa'anga tongien">Pa'anga tongien</option>
             <option value="Livre turque">Livre turque</option>
             <option value="Dollar de Trinité-et-Tobago">Dollar de Trinité-et-Tobago</option>
             <option value="Nouveau dollar de Taïwan">Nouveau dollar de Taïwan</option>
             <option value="Shilling tanzanien">Shilling tanzanien</option>
             <option value="Hryvnia ukrainienne">Hryvnia ukrainienne</option>
             <option value="Shilling ougandais">Shilling ougandais</option>
             <option value="Dollar américain">Dollar américain</option>
             <option value="Peso uruguayen">Peso uruguayen</option>
             <option value="Bolivar vénézuélien">Bolivar vénézuélien</option>
             <option value="Dong vietnamien">Dong vietnamien</option>
             <option value="Vatu vanuatuan">Vatu vanuatuan</option>
             <option value="Tala samoan">Tala samoan</option>
             <option value="Franc CFA (Afrique centrale)">Franc CFA (Afrique centrale)</option>
             <option value="Rial yéménite">Rial yéménite</option>
             <option value="Rand sud-africain">Rand sud-africain</option>
             <option value="Kwacha zambienne">Kwacha zambienne</option>
             <option value="Dollar zimbabwéen">Dollar zimbabwéen</option>
             <option value="Afghani afghan">Afghani afghan</option>
