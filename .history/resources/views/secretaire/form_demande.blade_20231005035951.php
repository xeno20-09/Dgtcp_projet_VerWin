...
function valeur_p() {
      ...
      // Convertir la variable PHP $dev en JSON
        for (const d of devises) {  console.log(d.devise);
    console.log('Nom de la devise : ' + d.devise);
    console.log('Valeur de la devise : ' + d.valeur);
}
