...
<option value="Coris-Bank Bénin">Coris-Bank Bénin</option>
    ...
    window.intlTelInput(input,{});    // Écouteur d'événement pour détecter les changements de code de pays
        var selectedCountry = e.target.getSelectedCountryData();
        var codeCountryInput = document.querySelector("#codecountry");
        codeCountryInput.value =  window.intlTelInput(input,{}); // Met à jour la valeur du champ hidden
