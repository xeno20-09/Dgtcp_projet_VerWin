...
<script>
    document.addEventListener("DOMContentLoaded", function() {
        ...
        // Affichez le code du pays dans la console (vous pouvez le personnaliser selon vos besoins)
        console.log("Code du pays sélectionné : " + countryCode);

        // Passez countryCode à la vue Laravel
        @php
            $countryCode = "<script>document.write(countryCode);</script>";
        @endphp
    });
</script>
