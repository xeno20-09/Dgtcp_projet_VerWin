    ...
    <div class="row">
        ...
        <div class="col">
            <div class="form-group">
                ...
                <input maxlength="14" minlength="12" name="tel_client" type="number" >
                    <input id="phone" type="tel" name="phone" class="form-control"  id="" placeholder="TelClient">
        ...
        <div class="container">
            <form id="login" onsubmit="process(event)">
              ...
              <input type="submit" class="btn" value="Vérifier" />
            </form>
           </div>
        <div class="col">
            <div class="form-group">
