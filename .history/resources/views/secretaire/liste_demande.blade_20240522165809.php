...
<div class="container">
    ...
    <h1>Liste des demandes approvés </h1>
        ...
        <tbody>
            ...
            <tr class="table-primary">
                ...
                <td>
                    ...
                    <a href="{{ route('get_update_form_ask', ['id_user' => $item['id']]) }} " class="table-link">
                        <span class="fa-stack">
                ...
                <td>
                    <a style="width: auto; height:fit-content;"
                        href="{{ route('get_rec_ask', ['id_ask' => $item['id']]) }}" class="btn btn-primary">Reçu</a>
                </td>
                {{--
