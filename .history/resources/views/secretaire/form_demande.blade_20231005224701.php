    ...
    <div class="row">
        ...
        <div class="col">
            <div class="form-group">
                ...
                <input name="montant_in" type="number" onchange="test()" class="form-control"  id="montant_in" placeholder="Montant ">
            </div>
        </div>
        ...
        <div class="col" id="mont_fcfa_p">
            <div class="form-group">
                ...
                <input name="mont_fcfa" type="text" class="form-control" id="montant_fcfa"  placeholder="Contre montant" >
            </div>
        </div>
...
<script>
    ...
    function test() {
            ...
            var valeur = document.getElementById('valeur_p').value || 0 ;
       ...
       //  var nombre2 = parseFloat(document.getElementById('nombre2').value) || 0;
            ...
            console.log (valeur);
            // Mise à jour du champ Résultat avec le résultat de la multiplication.
            document.getElementById('mont_fcfa').value = resultat;
        }
        test();
         </script>
          <script>
