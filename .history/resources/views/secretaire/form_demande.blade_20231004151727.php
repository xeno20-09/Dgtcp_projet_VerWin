...
<div id="physique">
    ...
    <div class="row">
        ...
        <div class="col">
            <div class="form-group">
                <select style="top: 56px;" class="form-select position-relative" name='currency_from_p'
                    aria-label="Default select example" onchange="valeur_p()" required>
        ...
        <div class="col" id="valeur">
            <div class="form-group">
                <label for="" class="form-label mt-4">Valeur </label>
                <input name="valeur_p" type="text" class="form-control"  placeholder="Valeur" disabled>
            </div>
        </div>
        <div class="col" id="mont_fcfa">
            <div class="form-group">
                <label for="" class="form-label mt-4">Contre montant </label>
                <input name="mont_fcfa_p" type="text" class="form-control"  placeholder="Contre montant" disabled>
            </div>
        </div>
...
<div id="morale">
    ...
    <div class="row">
        ...
        <div class="col"id="valeur">
            <div class="form-group">
                <label for="" class="form-label mt-4">Valeur </label>
                <input name="valeur" type="text" class="form-control"  placeholder="Valeur" disabled>
            </div>
        </div>
        <div class="col"id="mont_fcfa">
            <div class="form-group">
                <label for="" class="form-label mt-4">Contre montant </label>
                <input name="mont_fcfa" type="text" class="form-control"  placeholder="Contre montant" disabled>
            </div>
        </div>
