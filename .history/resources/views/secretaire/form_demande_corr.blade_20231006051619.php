...
@section('content')
    ...
    @foreach ($user as $item)
        @foreach ($demande as $item1)
            <form action="{{ route('store_correction_form_ask', $item1->id) }}" method="post" @endforeach
                @extends('layout.secretaire.header')
                @section('content')
                    <h1 style="text-align: center;">
                        @foreach ($user as $item)
                    ...
                    @foreach ($user as $item)
                    @foreach ($demande as $item1)
                        <form action="{{ route('store_correction_form_ask', $item1->id) }}" method="post" class="card-body cardbody-color p-lg-5">
                      ...
                      {{--   @foreach ($user as $item)
                        ...
                        <div class="col">
                            <div class="form-group">
                                ...
                                <input name="num_save" type="texte" value="{{ $item1->num_save }}" class="form-control" id=""
                                    aria-describedby="" placeholder="">
                ...
                <div id="morale">
                    ...
                    <div class="row">
                        ...
                        <div class="col">
                            <div class="form-group">
                                ...
                                <input name="boite" type="text" value="{{ $item1->boite }}" class="form-control" id=""
                    ...
                    <div class="row">
                        ...
                        <div class="col">
                            <div class="form-group">
                                ...
                                <input name="montant_in" value="{{ $item1->montant}}" type="number" class="form-control" oninput="test1()" id="montant_in_m" placeholder="Montant ">
                            </div>
                        </div>
                        ...
                        <div class="col"id="valeur_m">
                            <div class="form-group">
                                ...
                                <input name="valeur" type="text" class="form-control" value="{{ $item1->valeur }}"id="val1"  placeholder="Valeur" readonly>
                            </div>
                        </div>
                        <div class="col"id="mont_fcfa_m">
                            <div class="form-group">
                                <label for="" class="form-label mt-4">Contre montant </label>
                                <input name="mont_fcfa" type="text" class="form-control" value="{{ $item1->montant_con }}" id="montant_fcfa_m"  placeholder="Contre montant" readonly>
                            </div>
                        </div>
                    ...
                    <div class="row">
                        <div class="col">
                            <div class="form-group">
                                ...
                                <input name="nomsociete" type="text" class="form-control" value={{ $item1->nomsociete }} id="nom" placeholder="Nom societe">
                            </div>
                        </div>
                        <div class="col">
                            <div class="form-group">
                                <label for="" class="form-label mt-4">Catégorie</label>
                                <input name="categorie" type="text" value={{ $item1->categorie }} class="form-control" id="prenom"
                        ...
                        <div class="col">
                            <div class="form-group">
                                ...
                                <input name="adresse" type="text" value="{{ $item1->adresse }}"class="form-control" id=""
                                    placeholder="Adresse">
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col">
                         ...
                         <input id="phone" type="tel" name="tel_client" value="{{ $item1->tel_client }}" class="form-control" style=""  placeholder="TelClient">
                            </div>
                        </div>
                        ...
                        <div class="col">
                            <div class="form-group">
                                ...
                                <input name="num_compt_client"  value={{ $item1->num_compt_client }} type="text" class="form-control"
                ...
                <div id="physique">
                    ...
                    <div class="row">
                        ...
                        <div class="col">
                            <div class="form-group">
                                <label for="" class="form-label mt-4">Montant </label>
                                <input name="montant_in" value="{{ $item1->montant }}" type="number" oninput="test()" class="form-control"  id="montant_in" placeholder="Montant ">
                            </div>
                        </div>
                        ...
                        <div class="col" id="valeur_p">
                            <div class="form-group">
                                <label for="" class="form-label mt-4">Valeur </label>
                                <input name="valeur" type="text" id="val" value="{{ $item1->valeur }}" class="form-control"  placeholder="Valeur" readonly>
                        ...
                        <div class="col" id="mont_fcfa_p">
                            <div class="form-group">
                                <label for="" class="form-label mt-4">Contre montant </label>
                                <input name="mont_fcfa" type="text" class="form-control" value="{{ $item1->montant_con }}" id="montant_fcfa"  placeholder="Contre montant" readonly>
                            </div>
                        </div>
                    ...
                    <div class="row">
                        <div class="col">
                            <div class="form-group">
                                ...
                                <input name="nom_client" type="text" value="{{ $item1->nom_client }}" class="form-control" id="nom" placeholder="Nom client">
                            </div>
                        </div>
                        <div class="col">
                            <div class="form-group">
                                <label for="" class="form-label mt-4">Prenom client</label>
                                <input name="prenom_client" type="text"value="{{ $item1->prenom_client }}"  class="form-control" id="prenom"
                        ...
                        <div class="col">
                            <div class="form-group">
                                ...
                                <input name="profess_client" type="text"value="{{ $item1->profess_client }}"  class="form-control" id=""
