...
{{--     <script>
    ...
    <script>
        ...
        var letype=document.getElementById('type').value
        var societe = document.getElementById('morale');
        var particulier = document.getElementById('physique');
// Obtenez une référence à la div que vous souhaitez vider
var divMorale = document.getElementById("morale");

// Supprimez tous les éléments enfants de la div
     if (type === 'morale') {
 ...
 */      while (divMorale.firstChild) {
    divMorale.removeChild(divMorale.firstChild);
}
     } else {
            societe.style.display = 'none';
            particulier.style.display = 'none';
