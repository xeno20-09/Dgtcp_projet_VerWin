          ...
          {{--   {{--   @foreach ($user as $item)
            ...
            <div class="col">
                <div class="form-group">
                    ...
                    @foreach ($demande as $item1)
                        <input name="date_depot" type="texte" value="{{ $item1->date }}" class="form-control"
            ...
            <div class="col">
                <div class="form-group">
                    <select style="top: 56px;" class="form-select position-relative" name='currency_from'
                        ...
                        <option value="GBP" @if (Request::get('currency_from') == 'GBP') selected @endif>Great Britain Pound
                        </option>
            ...
            <div class="col">
                <div class="form-group">
                    ...
                    <input maxlength="14" minlength="12" value="{{ $item1->tel_client }}" name="tel_client"
                        type="text" class="form-control" id="" placeholder="TelClient">
                </div>
            </div>
