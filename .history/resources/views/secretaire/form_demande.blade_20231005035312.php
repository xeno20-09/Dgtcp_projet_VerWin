...
function valeur_p() {
        ...
        var resultatRecherche = devises.find(function(devise) {
    return devise.nom === "Dollar canadien";
});

if (resultatRecherche) {
    console.log('Valeur de la devise : ' + resultatRecherche.valeur);
} else {
    console.log('Devise non trouvée');
}
        }
        else{
