                    ...
                    <div class="row">
                        ...
                        <div class="col">
                            <div class="form-group">
                                ...
                                @endif
                                @if ( (($restant<$montantligne[$i])||($montantdmd>$montantligne[$i]))&&($restant!='r'))
                                <label for='montantdmd'>Montant de la demande</label>
                                <input type='number' value='{{ $montantdmd }}' name='montantdmd[]'
                                    id='montantdmd' style='background-color: red' placeholder='Montant de la demande'
                                    class='form-control'readonly>
                                ...
                                @endif
                                @php
                                    if($restant<$montantligne[$i]&&$restant!='r') {
                                        echo"<label for='montantdmd'>Montant de la demande</label>";
                                echo"<input type='number' value=' $montantdmd ' name='montantdmd[]'
                                    id='montantdmd' style='background-color: red' placeholder='Montant de la demande'
                                    class='form-control'readonly>";
                                    }
                                @endphp
                                @if ( ($montantdmd<$montantligne[$i])&&($restant=='r'))
                                <label for='montantdmd'>Montant de la demande</label>
                                <input type='number' value='{{ $montantdmd }}' name='montantdmd[]'
