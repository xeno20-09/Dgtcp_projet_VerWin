                ...
                <div class="row" >
                    ...
                    <div class="col">
                        <div class="form-group">
                            ...
                            <input name="pieces_doss[]" type="text"class="form-control" id="pieces"
                                placeholder="pieces">
                    ...
                    <div class="col">
                        <div class="form-group">
                            ...
                            <input name="ref_doss[]" type="text"class="form-control" id="refs"
                    ...
                    <div class="col">
                        <div class="form-group">
                            ...
                            <input name="exp_pieces[]" type="text"class="form-control" id="expi"
...
<script>
    ...
    document.addEventListener("DOMContentLoaded", function () {
        ...
        boutonAjouter.addEventListener("click", function () {
            ...
            var piece = clonedRow.getElementById("pieces");
            var refs = clonedRow.getElementById("refs");
            var datex = clonedRow.getElementById("expi");
var btn=clonedRow.getElementById('"ajouterChamp");
