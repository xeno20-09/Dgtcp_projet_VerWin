    ...
    <form action="{{ url('FormulaireSave_verificateur', $item_c->id) }}" method="Post"
        ...
        <div id="physique">
            ...
            <div class="row">
                ...
                <div class="col">
                    <div class="form-group">
                        <label for="" class="form-label mt-4">Prénom(s) du demandeur</label>
            ...
            <div class="row">
                ...
                <div class="col">
                    <div class="form-group">
                        <label for="" class="form-label mt-4">Téléphone du demandeur</label>
        ...
        <div id="container" style="  width: 1362px;">
            <div class="row">
                ...
                <div class="col">
                    <div class="form-group">
                        <label for="" class="form-label mt-4">Référence de la pièce</label>
                ...
                <div class="col">
                    <div class="form-group">
                        <label for="" class="form-label mt-4">Montant ligne</label>
                        <div class="row" style="po">
                            <input name="montantligne[]" type="number" class="form-control" id="mligne"
                            placeholder="Montant ligne">
                            <input name="devise" type="texte" class="form-control" id="devise"
                            placeholder="{{ $item_c->devise }}">
                        </div>
