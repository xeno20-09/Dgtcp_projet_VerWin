                ...
                @for ($i = 0; $i < $item_c->nombre_doc; $i++)
                    <div class="row">
                        ...
                        <?php if ($e == 'ok') {
                            ...
                            echo "<label for='montantrestant'>Montant de la Restant</label>";
                            echo "<input type='number' name='montantrestant[]' id='montantrestant'
                        ...
                        <div class="col">
                            <div class="form-group">
                                ...
                                <input type="number" max="<?php echo $valeurMax; ?>" name="montantligne[]" id="montantligne"
                        ...
                        <div class="col">
                            <div class="form-group">
                                <label for="montantligne">Montant de la demande</label>
                                <input type="number" max="<?php echo $valeurMax; ?>" name="" id="montantdmd"
                                    placeholder="Montant de la demande" class="form-control">
                            </div>
                        </div>
                    </div>
                @endfor
