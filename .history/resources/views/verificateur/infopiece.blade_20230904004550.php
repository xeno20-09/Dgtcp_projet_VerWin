                    ...
                    <div class="row">
                        ...
                        <div class="col">
                            ...
                            placeholder='Montant de la demande' style='background-color: rgb(199, 255, 199)' class='form-control'>";
                                ...
                                ?>
<a href=''><button  style='background-color: rgb(255, 112, 112)'>Rejeter</button></a>
                            </div>
                        </div>
                    </div>
                @endfor
            ...
            if ($valeurMax < $montantdmd && $valeurMax != null) {                echo "<button type='submit' class='btn btn-primary'>Enregistrer</button>"
}
