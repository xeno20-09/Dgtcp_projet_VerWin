        ...
        @foreach ($demande as $item_c)
            ...
            <form action="{{ url('FormulaireSave_verificateur', $item_c->id) }}" method="Post"
                ...
                <div class="row" id="container">
                    <div class="col">
                        <div class="form-group">
                            <label for="pieces" class="form-label mt-4">Pieces</label>
                            <input name="pieces_doss" type="text" class="form-control" id="pieces" placeholder="pieces">
                        </div>
                    </div>
                    <div class="col">
                        <div class="form-group">
                            <label for="ref_pieces" class="form-label mt-4">Reference piece</label>
                            <input name="ref_doss" type="text" class="form-control" id="ref_pieces" placeholder="ref pieces">
                        </div>
                    </div>
                    <div class="col">
                        <div class="form-group">
                            <label for="exp_pieces" class="form-label mt-4">Date d'expiration de la piece</label>
                            <input name="exp_pieces" type="text" class="form-control" id="exp_pieces" placeholder="date expiration pieces">
                        </div>
                    </div>
                </div>
                <div class="col">
