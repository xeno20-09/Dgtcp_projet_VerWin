              ...
              <div id="morale">
                  ...
                  <div class="row">
                      <div class="col">
                          <div class="form-group">
                              <label for="" class="form-label mt-4">Nature des opérations</label>
                              <input name="nature_op" value="{{ $item->nature_op}}" type="text" class="form-control" id=""
                      ...
                      <div class="col">
                          <div class="form-group">
                              <label for="" class="form-label mt-4">Nature des produits</label>
                              <input name="nature_pro"value="{{ $item->nature_p }}" type="text" class="form-control" id=""
                      ...
                      <div class="col">
                          <div class="form-group">
                              ...
                              <input name="boite" type="text" value="{{ $item->boite }}" class="form-control" id=""
                  ...
                  <div class="row">
                      ...
                      <div class="col">
                          <div class="form-group">
                              <label for="" class="form-label mt-4">Montant </label>
                              <input name="montant_in" value="{{ $item->montant}}" type="number" class="form-control" oninput="test1()" id="montant_in_m" placeholder="Montant ">
                          </div>
                      </div>
                      ...
                      <div class="col"id="valeur_m">
                          <div class="form-group">
                              ...
                              <input name="valeur" type="text" class="form-control" value="{{ $item->valeur }}"id="val1"  placeholder="Valeur" readonly>
                          </div>
                      </div>
                      <div class="col"id="mont_fcfa_m">
                          <div class="form-group">
                              <label for="" class="form-label mt-4">Contre montant </label>
                              <input name="mont_fcfa" type="text" class="form-control" value="{{ $item->montant_con }}" id="montant_fcfa_m"  placeholder="Contre montant" readonly>
                          </div>
                      </div>
                  ...
                  <div class="row">
                      <div class="col">
                          <div class="form-group">
                              ...
                              <input name="nomsociete" type="text" class="form-control" value={{ $item->nomsociete }} id="nom" placeholder="Nom societe">
                          </div>
                      </div>
                      <div class="col">
                          <div class="form-group">
                              <label for="" class="form-label mt-4">Catégorie</label>
                              <input name="categorie" type="text" value={{ $item->categorie }} class="form-control" id="prenom"
                      ...
                      <div class="col">
                          <div class="form-group">
                              ...
                              <input name="adresse" type="text" value="{{ $item->adresse }}"class="form-control" id=""
                                  placeholder="Adresse">
                          </div>
                      </div>
                  </div>
                  ...
                  <div class="row">
                      ...
                      <div class="col">
                       ...
                       <input id="phone" type="tel" name="tel_client" value="{{ $item->tel_client }}" class="form-control" style=""  placeholder="TelClient">
                          </div>
                      </div>
                      ...
                      <div class="col">
                          <div class="form-group">
                              ...
                              <option value="{{ $item->banque_client }}">{{ $item->banque_client }}</option>
                      ...
                      <div class="col">
                          <div class="form-group">
                              <label for="" class="form-label mt-4">Numéro de compte</label>
                              <input name="num_compt_client"  value={{ $item->num_compt_client }} type="text" class="form-control"
                      ...
                      <div class="row">
                        ...
                        <div class="col">
                            <div class="form-group">
                                ...
                                <option value="{{ $item_c->devise }}">{{ $item_c->devise }}</option>
                                <option value="Euro">Euro</option>
                                <option value="Dollar us">Dollar us</option>
                                <option value="Yen japonais">Yen japonais</option>
                                <option value="Livre sterling">Livre sterling</option>
