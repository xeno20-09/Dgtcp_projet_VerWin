        ...
        @foreach ($demande as $item_c)
            ...
            @endphp
                    ...
                    <div class="row">
                        ...
                        <div class="col">
                            <div class="form-group">
                                ...
                                @if ( ($restant<=$montantligne[$i])||($montantdmd<=$montantligne[$i])||($restant!=0) )                                 <label for='montantdmd'>Montant de la demande</label>
                                <input type='number' value='{{ $montantdmd }}' name='montantdmd[]'
                ...
                @for ($i = 0; $i < $item_c->nombre_doc; $i++)
                    ...
                    @if ( ($restant<=$montantligne[$i])||($montantdmd<=$montantligne[$i])||($restant!=0)ezzz ) 
                    <div class="row mt-5">
                    <div class="col">
                        <div class="form-group">
