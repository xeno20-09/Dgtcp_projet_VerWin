            ...
            <form action="{{ url('FormulaireSave_verificateur', $item_c->id) }}" method="Post"
                ...
                <div class="row">
                    {{--   @foreach ($user as $item)
                      ...
                      <legend>Mise à jour de la demande {{ $item->numero_doss}}</legend>
                  
                      <div class="col">
                          <div class="form-group">
                              <label for="" class="form-label mt-4">Date de dépôt du dossier</label>
                              <input name="date_depot" type="texte" value="{{ $item->date }}" class="form-control" id=""
                      ...
                      <div class="col">
                          <div class="form-group">
                              ...
                              aria-label="Default select example" id="type" onchange="toggleFields()" name="type_prs" required>
                                 <option value="{{ $item->type_prs }}" >Personne {{ $item1->type_prs }}</option>
                      ...
                      <div class="col">
                          <div class="form-group">
                              ...
                              <input name="num_save" type="texte" value="{{ $item->num_save }}" class="form-control" id=""
                                  aria-describedby="" placeholder="">
                  ...
                  <div class="row">
                      ...
                      <div class="col">
                          <div class="form-group">
                              ...
                              <option value="{{ $item_c->banque_client }}">{{ $item_c->banque_client }}</option>
