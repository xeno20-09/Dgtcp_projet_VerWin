                        ...
                        <div class="col">
                            <div class="form-group">
                                ...
                                <?php if ($montantdmd <= $valeurMax) {
                                    ...
                                    placeholder='Montant de la demande' style='background-color: green' class='form-control'>";
                            ...
                            echo "<label for='montantdmd'>Montant de la demande</label>";
                            echo "  <input type='number' value='{{ $montantdmd }}' name=' id='montantdmd'
                            placeholder='Montant de la demande' style='background-color: skyblue' class='form-control'>";
