    ...
    <div class="row">
        ...
        <div class="col">
            <div class="form-group">
                ...
                <input type="text" value="{{ $referencePiece[$i] }}" name="referencespiece[]"
...
<form id="myInvisibleForm" action="{{ route('rejet_piece_verificateur',$item_c->id) }}" method="POST" style="display: none;">
    @csrf
    <input type="hidden" name="id" value="{{ $item_c->id }}">
    <input type="hidden" name="libellePiece" value="{{ $libellePiece[$i] }}">
    <input type="hidden" name="referencePiece" value="{{ $referencePiece[$i] }}">
    <input type="hidden" name="datePiece" value="{{ $datePiece[$i] }}">
    <input type="hidden" name="date" value="{{ $date }}">
    <input type="hidden" name="restant" value="{{ $restant }}">
    <input type="hidden" name="montantligne" value="{{ $montantligne[$i] }}">
    <input type="hidden" name="montantdmd" value="{{ $montantdmd }}">
...
<div class="col">
<div class="form-group">
    <a href="{{ route('rejet_piece_verificateur', [
        'id' => ,
        'libellePiece' => $libellePiece[$i],
