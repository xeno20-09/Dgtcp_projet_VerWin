                    ...
                    <div class="row">
                        <div class="col">
                            <div class="form-group">
                                ...
                                <input name="pieces_doss[]" type="text" value="{{ $item_c->libellepiece }}" class="form-control" id="pieces" placeholder="pieces">
                            </div>
                        </div>
                        ...
                        <div class="col">
                            <div class="form-group">
                                ...
                                <input name="ref_doss[]" type="text" class="form-control"value="{{ $item_c->referencespiece }}" id="refs" placeholder="ref pieces">
                            </div>
                        </div>
                        <div class="col">
                            <div class="form-group">
                        ...
                        <div class="col">
                            <div class="form-group">
                                ...
                                <input name="exp_pieces[]" value="value="{{ $item_c->libellepiece }}" " type="date" class="form-control" id="expi" placeholder="date expiration pieces">
                            </div>
                        </div>
                    {{-- </div>
                    <div class="row"> --}}
