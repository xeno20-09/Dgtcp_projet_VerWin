            ...
            <div class="row">
                ...
                <div class="col">
                    <div class="form-group">
                        ...
                        <input name="currency_from" value="{{ $item_c->devise }}" type="text" class="form-control"readonly>
            ...
            <div class="row">
                ...
                <div class="col">
                    <div class="form-group">
                        ...
                        <input name="categorie" type="text" value={{ $item_c->categorie }} class="form-control"
                        id="prenom"
                        placeholder="Catégorie"readonly>
                    </div>
                </div>
        ...
        <div id="physique">
            ...
            <div class="row">
                ...
                <div class="col" id="valeur_p">
                    <div class="form-group">
                        <label for="" class="form-label mt-4">Valeur </label>
                        <input name="valeur" type="text" id="val" value="{{ $item_c->valeur }}" class="form-control"
                            placeholder="Valeur" readonly>
            ...
            <div class="row">
                <div class="col">
                    <div class="form-group">
                        <label for="" class="form-label mt-4">Nom client demandeur</label>
                ...
                <div class="col">
                    <div class="form-group">
                        <label for="" class="form-label mt-4">Prenom client demandeur</label>
                ...
                <div class="col">
                    <div class="form-group">
                        <label for="" class="form-label mt-4">Profession client demandeur</label>
            ...
            <div class="row">
                ...
                <div class="col">
                    <div class="form-group">
                        <label for="" class="form-label mt-4">Telephone client demandeur</label>
                ...
                <div class="col">
                    <div class="form-group">
                        <label for="" class="form-label mt-4">Banque demandeur</label>
                ...
                <div class="col">
                    <div class="form-group">
                        <label for="" class="form-label mt-4">Numéro de compte demandeur</label>
        ...
        <div class="row">
            ...
            <div class="col">
                <div class="form-group">
                    ...
                    <input maxlength="12" minlength="12" name="num_compt_benifi" type="number" class="form-control"
                        id="" placeholder="Numéro de compte" value="{{ $item_c->num_compt_benefi }}">
