...
// Ajoutez un gestionnaire d'événements de clic au bouton "Retirer la pièce"
boutonRetirer.addEventListener("click", function () {
    // Sélectionnez le conteneur de la ligne que vous souhaitez supprimer
    var ligneASupprimer = boutonRetirer.closest(".row");

    // Vérifiez si la ligne existe avant de la supprimer
    if (ligneASupprimer) {
        ligneASupprimer.remove(); // Supprimez la ligne
    }
});
