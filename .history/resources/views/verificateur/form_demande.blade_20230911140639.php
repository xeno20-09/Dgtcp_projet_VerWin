                    ...
                    <div class="row"> --}}
                        ...
                        <div class="col">
                            <div class="form-group">
                                ...
                                <button onclick="ajout()" style="position: relative; top: 36px; right: 100px;" type="button" class="btn btn-primary" id="ajouterChamp">+</button>
                            </div>
                        </div>
...
//r=document.getElementById('retirer');
