                    ...
                    <div class="row">
                        ...
                        <div class="col">
                            <div class="form-group">
                                ...
                                <input name="dateexpi[]" value="{{ $item_d->dateexpi }}"  type="date" class="form-control" id="expi" placeholder="date expiration pieces">
                            </div>
                        </div> 
                        <div class="col">
                            <div class="form-group">
                ...
                <div id="container" style="  width: 1362px;">
                    <div class="row">
                        ...
                        <div class="col">
                            <div class="form-group">
                                <label for="" class="form-label mt-4">Date d'expiration de la piece</label>
                                <input name="dateexpi[]" value=" " type="date" class="form-control" id="expi" placeholder="date expiration pieces">
                            </div>
                        </div>
