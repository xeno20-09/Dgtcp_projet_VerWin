                ...
                <div class="row">
                    ...
                    <div class="col">
                        <div class="form-group">
                            ...
                            <input name="pieces_doss" type="text"class="form-control" id=""
                                placeholder="pieces">
                            <small id="Help" class="form-text text-muted">Apres chaque libelle de pieces mettre une
                                ","</small>
                        </div>
                    </div>
                    <div class="col">
                        <div class="form-group">
                            ...
                            <input name="ref_doss" type="text"class="form-control" id=""
                    ...
                    <div class="col">
                        <div class="form-group">
                            ...
                            <input name="exp_pieces" type="text"class="form-control" id=""
                    ...
                    <div class="col">
                        <div class="form-group">
                            <label for="" class="form-label mt-4">Ajouter une autre pieces</label>

                        <button style="position: relative; top: 0px;" type="button" class="btn btn-primary " id="ajouterChamp">+</button>
                    </div>
                </div>
                </div>
                <br>
