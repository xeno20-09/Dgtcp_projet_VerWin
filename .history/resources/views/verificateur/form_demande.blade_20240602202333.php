    ...
    <form action="{{ url('FormulaireSave_verificateur', $item_c->id) }}" method="Post"
        ...
        <div id="physique">
            ...
            <div class="row">
                <div class="col">
                    <div class="form-group">
                        <label for="" class="form-label mt-4">Nom  demandeur</label>
                ...
                <div class="col">
                    <div class="form-group">
                        <label for="" class="form-label mt-4">Prenom  demandeur</label>
            ...
            <div class="row">
                ...
                <div class="col">
                    <div class="form-group">
                        <label for="" class="form-label mt-4">Telephone  demandeur</label>
