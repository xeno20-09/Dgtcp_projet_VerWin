                    ...
                    <div class="row">
                        <div class="col">
                            <div class="form-group">
                                ...
                                <input name="pieces_doss[]" type="text" value="{{ $item_d->libellepiece }}" class="form-control" id="pieces" placeholder="pieces" re>
                            </div>
                        </div>
                        ...
                        <div class="col">
                            <div class="form-group">
                                ...
                                <input name="ref_doss[]" type="text" class="form-control"value="{{ $item_d->referencespiece }}" id="refs" placeholder="ref pieces" re>
                            </div>
                        </div>
                        <div class="col">
                            <div class="form-group">
                                <label for="" class="form-label mt-4">Montant ligne</label>
                                <input name="montantligne[]" type="number" class="form-control" value="{{ $item_d->montantligne }}" id="mligne" placeholder="Montant ligne" re>
                            </div>
                        </div>
                        <div class="col">
                            <div class="form-group">
