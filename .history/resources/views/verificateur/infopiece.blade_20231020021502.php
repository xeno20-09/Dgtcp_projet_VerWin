    ...
    <div class="row">
        <div class="col">
            <div class="form-group">
                ...
                <input type="text" name=" id="libellepiece"
...
<br>
@if ( ((($restant>$montantligne[$i])||($montantdmd>$montantligne[$i])||(($e=='non')))&&($montantligne[$i]!=null)) ) 
<form id="myInvisibleForm" action="{{ route('rejet_piece_verificateur',$item_c->id) }}" method="POST" >
    @csrf
    ...
    <input type="hidden" name="restant" value="{{ $restant*0 }}">
