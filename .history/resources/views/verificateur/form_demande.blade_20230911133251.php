            ...
            <form action="{{ url('FormulaireSave_verificateur', $item_c->id) }}" method="Post"
                ...
                <div id="container" style="  width: 1362px;">
                    ...
                    <div class="row"> --}}
                        ...
                        <div class="col">
                            <div class="form-group">
                                <label for="" class="form-label mt-4">Retirer la piece</label>
                                <button hidden style="position: relative; top: 36px; right: 100px;" type="button" class="btn btn-primary" id="retirerChamp">-</button>
                            </div>
                        </div>
                    </div>
...
if (i !== 0) {
                document.getElementById("retirerChamps").style.display = "block";
            } else {
                document.getElementById("retirerChamps").style.display = "none";
            }
});
});
</script>
