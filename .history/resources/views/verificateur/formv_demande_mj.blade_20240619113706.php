...
@section('content')
    <div class="container">
        ...
        @foreach ($demande as $item_c)
            ...
            <form action="{{ url('VerificateurS_Mj', $item_c->id) }}" method="Post" class="card-body cardbody-color p-lg-5"
                    ...
                    <div class="col">
                        <div class="form-group">
                            ...
                            <input name="pays_benifi" type="text" class="form-control" id=""
                                placeholder="PaysClient" value="{{ $item_c->pays_benifi }}">
                        </div>
                    </div>
                ...
                {{$piece}}
                    ...
                    <div class="row"> --}}
                            ...
                            <div class="col" id="retirer">
                                <div class="form-group">
                                    <label for="" class="form-label mt-4" id="lretirerChamp">Retirer la
                                        piece</label>
                                    <button style="position: relative; top: 36px; right: 100px;" type="button"
