                ...
                <div class="row">
                    <div class="col">
                        <div class="form-group">
                            ...
                            <input type="text" name="libellepiece" id="libellepiece" placeholder="Libellé de la pièce"
                    ...
                    <div class="col">
                        <div class="form-group">
                            ...
                            <input type="text" name="referencespiece" id="referencespiece"
                                placeholder="Références de la pièce" class="form-control" value="{{$referencesPieces}}">
                        </div>
                    </div>
                    ...
                    <div class="col">
                        <div class="form-group">
                            ...
                            <input type="texte" value="{{$date}}" name="date_piece" id="date_piece" class="form-control">
                        </div>
                    </div>
                    ...
                    <div class="col">
                        <div class="form-group">
                            ...
                            <input type="number" name="montantligne" id="montantligne" placeholder="Montant de la ligne"
                                class="form-control">
                        </div>
                    </div>
                </div>
