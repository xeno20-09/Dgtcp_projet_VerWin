                    ...
                    <div class="row">
                        <div class="col">
                            <div class="form-group">
                                ...
                                <input name="pieces_doss[]" type="text" class="form-control" id="pieces" placeholder="pieces"  value="{{ $piece['libellepiece }}">
                            </div>
                        </div>
                        ...
                        <div class="col">
                            <div class="form-group">
                                ...
                                <input name="ref_doss[]" type="text" class="form-control" id="refs" placeholder="ref pieces"value="{{ $piece->referencespiece }}">
                            </div>
                        </div>
                        <div class="col">
                            <div class="form-group">
                                <label for="" class="form-label mt-4">Montant ligne</label>
                                <input name="montantligne[]" type="number" class="form-control" id="mligne" placeholder="Montant ligne"value="{{ $piece->montantligne }}">
                            </div>
                        </div>
                        <div class="col">
                            <div class="form-group">
                                <label for="" class="form-label mt-4">Date d'expiration de la piece</label>
                                <input name="exp_pieces[]" value=" " type="date" class="form-control" id="expi" placeholder="date expiration pieces"value="{{ $piece->dateexpi }}">
                            </div>
                        </div>
                    {{-- </div>
                    <div class="row"> --}}
