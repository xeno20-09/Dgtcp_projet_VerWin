...
$valeurMax = $valeurMax;  
            ...
            @endphp
                @for ($i = 0; $i < $item_c->nombre_doc; $i++)
                        ...
                        @if ($datePiece[$i] != null)
                            <div class="col">
                                <div class="form-group">
                                    ...
                                    <input type="text" value="{{ $datePiece[$i] }}" name="datepiece[]"
                                        id="datepiece{{ $i }}" placeholder="Date d'expiration" class="form-control">
                                </div>
                            </div>
                        @endif
                    ...
                    <div class="row">
                        ...
                        <div class="col">
                            <div class="form-group">
                                @if ($montantdmd <= $valeurMax&&$valeurMax!=0)
                                    ...
                                    <input type='number' value='{{ $montantdmd }}' name='montantdmd[]'
                                        ...
                                        style='background-color: rgb(199, 255, 199)' class='form-control'>
                                @elseif (  $montantdmd>$valeurMax&&$valeurMax!=0)
                                    <label for='montantdmd'>Montant de la demande</label>
                                    <input type='number' value='{{ $montantdmd }}' name='montantdmd[]'
                                        id='montantdmd' placeholder='Montant de la demande'
                                        style='background-color: rgb(255, 112, 112)' class='form-control'>
                                @endif
                            </div>
                        </div>
                             <div class='col'>
                            <div class='form-group'>
                                @if ($e == 'ok')
                                    ...
                                    <input type='number' value='{{ $restant }}' name='montantrestant[]'
                                        ...
                                        placeholder='Montant de la Restant' class='form-control'>
                                @endif
                            </div>
                        </div>
                    </div>
            ...
            @if ($valeurMax < $montantdmd&&$valeurMax!=0)
