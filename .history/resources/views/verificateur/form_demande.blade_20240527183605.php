            ...
            <div class="row">
                ...
                <div class="col" id="valeur_m">
                    <div class="form-group">
                        ...
                        <input name="valeur" type="text" class="form-control" value="{{ $item_c->valeur }}" id="val1"
        ...
        <div id="container" style="  width: 1362px;">
            <div class="row">
                <div class="col">
                    <div class="form-group">
                        <label for="" class="form-label mt-4">Pieces</label>
                        <input name="pieces_doss[]" type="text" class="form-control" id="pieces" placeholder="pieces" re>
                    </div>
                </div>
