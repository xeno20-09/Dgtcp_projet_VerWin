...
@section('content')
    <div class="container">
        ...
        @foreach ($demande as $item_c)
            ...
            <form action="{{ url('FormulaireSave_verificateur', $item_c->id) }}" method="Post"
                ...
                <div class="row">
                    ...
                    <select name="" id="">
                        <option value=""><img  width="20" height="15" src="{{ asset('images/' ."AF" . '.png') }}">Afghanistan
                        </option>
                    </select>
        ...
        <img  width="20" height="15" src="{{ asset('images/' ."AF" . '.png') }}"> <option value="AF">Afghanistan</option>
