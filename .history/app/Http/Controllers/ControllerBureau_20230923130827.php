...
class ControllerBureau extends Controller
{
    ...
    public function liste_demand_n(Request $request)
    {
        $id = Auth::id();
        $user = User::where('id', '=', $id)->get();
        $demande = demande::where('status_dmd', '=', 'En cours')->where('vu_chef_division', '=', 1)->->orwhere('motif', '=', 'Rejetée pour incorformité au niveau des montants')where('vu_chef_bureau', '=', 0)->get();
