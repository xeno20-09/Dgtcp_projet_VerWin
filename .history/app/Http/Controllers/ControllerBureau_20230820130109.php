...
class ControllerBureau extends Controller
{
    ...
    public function stor(Request $request, $idc)
    {
      ...
      $visa_n= $data['visa_chef_bureau_n'] ;
        if(($data['visa_chef_bureau'] == true)&&($data['visa_chef_bureau_n'] == false))  {
            $visa = 1;
        }  if (($data['visa_chef_bureau_n'] == true)&&($data['visa_chef_bureau_n'] == false)) {
            $visa = 0;
        }
