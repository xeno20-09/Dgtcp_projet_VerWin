...
class ControllerVerificateur extends Controller
{
    ...
    public function get_list_ask_n_verificateur(Request $request)
    {
        $id = Auth::id();
        $user = User::where('id', '=', $id)->get();
    ...
    public function get_form_ask(Request $request, $id)
    {
        $id_c = Auth::id();
    ...
    public function store_form_piece(Request $request, $id_d)
    {
        $id = Auth::id();
        $data = $request->all();
    ...
    public function store_update_form_ask(Request $request, $idc)
    {
        $id = Auth::id();
    ...
    public function get_list_piece()
    {
        $id = Auth::id();
        ...
        return view('verificateur.listepiece', compact('pieces', 'dmd_n_lu', 'name_v'));
    }
