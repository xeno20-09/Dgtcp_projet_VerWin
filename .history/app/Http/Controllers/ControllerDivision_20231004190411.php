...
class ControllerDivision extends Controller
{
    ...
    public function adddevise(Request $request, $id)
    {
        ...
        // Création d'un nouveau modèle avec les données du formulaire
        $dmd_chef_division = listedevise::all();
        $dmd_secretaire = new listedevise();

        $dmd_chef_division->nom = $data['date'];
        ...
        return view('chef_division.form_add_devis', compact('user', 'dmd_n_lu', 'dmd_back'));
    }
