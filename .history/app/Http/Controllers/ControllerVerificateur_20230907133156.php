...
class ControllerVerificateur extends Controller
{
    ...
    public function checkref(Request $request$libellePiece, $referencePiece, $datePiece, $montantligne, $idm)
    {
        // dd($libellePiece);
        ...
        for ($i = count($referencesPieces) - 1; $i >= 0; $i--) {
            ...
            if ($referencePiece[$i] == null) {

                $resultat = $this->store_piece_dmd($request,$idm);
                return $resultat;
            }
