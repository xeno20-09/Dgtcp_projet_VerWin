...
class ControllerClient extends Controller
{
    ...
    public function createPDF(Request $request, $id)
    {
        ...
        $pdf = PDF::loadView(
            'client.pdf_view',
            [
                'numero_doss', 'date', 'nature_p', 'nature_op', 'montant', 'montant_con','devise', 'nom_client', 'prenom_client', 'profess_client', 'tel_client','banque_client', 'num_compt_client', 'status_dmd', 'devise', 'nom_benefi','prenom_benefi', 'profess_benefi', 'pays_benifi', 'banque_benefi','num_compt_benefi','date_decision'
            ]
        );
