...
class ControllerVerificateur extends Controller
{
    ...
    public function store(Request $request, $idc)
    {
        ...
        if ($request->hasFile('file')) {
            $fileNames = []; // Utilisez un nom de variable différent pour éviter la confusion
            ...
            // Enregistrer les noms des fichiers dans votre modèle en utilisant un champ sérialisé
            $dmd_verificateur->file = serialize($fileNames);
        }
