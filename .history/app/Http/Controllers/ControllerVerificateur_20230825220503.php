    ...
    public function store(Request $request, $idc)
    {
        ...
        if ($request->hasFile('file')) {
            ...
            if ($changes != null) {
                ...
                $changes->id_dmd = $changes->id_dmd;
                $changes->nom_d = $changes->nom_d;
                $changes->nom_b = $changes->nom_b;
                $changes->nom_v = $changes->nom_v;
                $changes->libellepiece = $changes->libellepiece;
                $changes->referencespiece = $changes->referencespiece;

                $changes->date  = $changes->date;
                $changes->numero_doss = $changes->numero_doss;
                $changes->montantligne = $changes->montantrestant;
                $changes->montantinitial = $changes->montantinitial;
