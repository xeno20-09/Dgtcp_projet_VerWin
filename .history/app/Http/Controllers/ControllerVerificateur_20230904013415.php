...
class ControllerVerificateur extends Controller
{
    ...
    public function checkref(Request $request, $idm)
    {
        ...
        dd(where('referencespiece', '=', $referencesPieces[$i])->orderByDesc('id'));

            $dmd_verificateur = piece::where('referencespiece', '=', $referencesPieces[$i])->orderByDesc('id')->first()/* find($referencesPieces[$i]) */;
