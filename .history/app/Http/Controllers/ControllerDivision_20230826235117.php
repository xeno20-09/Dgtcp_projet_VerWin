...
class ControllerDivision extends Controller
{
    public function home()
    {
        ...
        $dmd_back = count(demande::where('back_verificateur', '=', 1)->where('vu_chef_verificateur', '=', 1)->where('vu_chef_division', '=', 1)->get());
        $dmd_n_lu = count(demande::where('vu_verificateur', '=', 0)->get()) - $dmd_back;
