...
class ControllerSecretaire extends Controller
{
    ...
    public function store_form_ask_suite(Request $request)
    {
        ...
        $nom_client = $dmd_secretaire->nom_client;
        $prenom_client = $dmd_secretaire->prenom_client;
        $profess_client = $dmd_secretaire->profess_client;
        $tel_client  $dmd_secretaire->tel_client;
