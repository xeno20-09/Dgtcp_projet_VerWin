...
class ControllerVerificateur extends Controller
{
    ...
    public function liste_demande_n(Request $request)
    {
        ...
        $jointure = DB::table('users')
            ...
            ->get();
        $dmd_n_lu = count(demande::where('vu_verifi', '=', 0)->get());        $dmd_back = count(demande::where('back_secret', '=', 1)->where('vu_verifi', '=', 1)->where('vu_secret', '=', 1)->get());
        $dmd_n_lu = count(demande::where('vu_verifi', '=', 0)->get()) - $dmd_back;
    ...
    public function  form(Request $request, $id_dmd)
    {
        ...
        $demande = (demande::where('id', '=', $id_dmd)->get());        $dmd_back = count(demande::where('back_secret', '=', 1)->where('vu_verifi', '=', 1)->where('vu_secret', '=', 1)->get());
        $dmd_n_lu = count(demande::where('vu_verifi', '=', 0)->get()) - $dmd_back;
    ...
    public function store(Request $request, $idc)
    {
        ...
        if ($request->hasFile('file')) {
            ...
            $file = $fileNames;
            $date = now();        $dmd_back = count(demande::where('back_secret', '=', 1)->where('vu_verifi', '=', 1)->where('vu_secret', '=', 1)->get());
        $dmd_n_lu = count(demande::where('vu_verifi', '=', 0)->get()) - $dmd_back;
