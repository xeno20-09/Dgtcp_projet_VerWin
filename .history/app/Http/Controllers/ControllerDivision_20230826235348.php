...
class ControllerDivision extends Controller
{
    public function home()
    {
        ...
        $dmd_back = count(demande::where('back_verificateur', '=', 1)->where('vu_verificateur', '=', 1)->where('vu_chef_division', '=', 1)->get());
        $dmd_n_lu = count(demande::where('vu_chef_division', '=', 0)->get()) - $dmd_back;
    ...
    public function liste_demandes_n(Request $request)
    {
        ...
        $jointure1 = DB::table('users')
            ...
            ->select('demandes.*', 'users.*')
            ->get();
        $dmd_n_lu = count(demande::where('vu_chef_division', '=', 0)->get());      $dmd_back = count(demande::where('back_verificateur', '=', 1)->where('vu_verificateur', '=', 1)->where('vu_chef_division', '=', 1)->get());
        $dmd_n_lu = count(demande::where('vu_chef_division', '=', 0)->get()) - $dmd_back;
    ...
    public function formulaires(Request $request, $id)
    {
        ...
        $dmd_chef_division->update();      $dmd_back = count(demande::where('back_verificateur', '=', 1)->where('vu_verificateur', '=', 1)->where('vu_chef_division', '=', 1)->get());
        $dmd_n_lu = count(demande::where('vu_chef_division', '=', 0)->get()) - $dmd_back;
    ...
    public function  form(Request $request, $id_dmd)
    {
        ...
        $demande = (demande::where('id', '=', $id_dmd)->get());      $dmd_back = count(demande::where('back_verificateur', '=', 1)->where('vu_verificateur', '=', 1)->where('vu_chef_division', '=', 1)->get());
        $dmd_n_lu = count(demande::where('vu_chef_division', '=', 0)->get()) - $dmd_back;
    ...
    public function stores(Request $request, $idc)
    {
        ...
        $jointure1 = DB::table('users')
            ->join('demandes', 'users.id', '=', 'demandes.id_verifi')
            ->select('demandes.*', 'users.*')
            ->get();      $dmd_back = count(demande::where('back_verificateur', '=', 1)->where('vu_verificateur', '=', 1)->where('vu_chef_division', '=', 1)->get());
        $dmd_n_lu = count(demande::where('vu_chef_division', '=', 0)->get()) - $dmd_back;
    ...
    public function liste_demandes(Request $request)
    {
        ...
        $dmd_n_lu = count(demande::where('vu_chef_division', '=', 0)->get());      $dmd_back = count(demande::where('back_verificateur', '=', 1)->where('vu_verificateur', '=', 1)->where('vu_chef_division', '=', 1)->get());
        $dmd_n_lu = count(demande::where('vu_chef_division', '=', 0)->get()) - $dmd_back;
        return view('chef_division.liste_demande', compact('demande', 'dmd_back', 'dmd_n_lu', 'user', 'jointure', 'jointure1', 'dmd_n_lu'));
    }
