...
class ControllerVerificateur extends Controller
{
    public function home()
    {
        ...
        $dmd_back = count(demande::where('back_secret', '=', 1)->where('vu_verifi', '=', 1)->where('vu_secret', '=', 1)->get());
        $dmd_n_lu = count(demande::where('vu_verifi', '=', 0)->get()) - $dmd_back;
    ...
    public function liste(Request $request)
    {
        ...
        $dmd_back = count(demande::where('back_secret', '=', 1)->where('vu_verifi', '=', 1)->where('vu_secret', '=', 1)->get());
        $dmd_n_lu = count(demande::where('vu_verifi', '=', 0)->get()) - $dmd_back;
        return view('verificateur.liste_demande', compact('demande', 'dmd_back', 'dmd_n_lu', 'user', 'jointure', 'dmd_n_lu'));
    }
    ...
    public function   detaille(Request $request, $id)
    {
        ...
        $dmd_back = count(demande::where('back_secret', '=', 1)->where('vu_verifi', '=', 1)->where('vu_secret', '=', 1)->get());
        $dmd_n_lu = count(demande::where('vu_verifi', '=', 0)->get()) - $dmd_back;
        return view('verificateur.detaille_demande', 'dmd_back', compact('demande', 'user', 'dmd_n_lu', 'jointure', 'dmd_n_lu'));
    }
    public function retour(Request $request, $id)
    {
        ...
        $dmd_back = count(demande::where('back_verifi', '=', 1)->where('vu_verifi', '=', 1)->where('vu_chef_division', '=', 1)->get());
