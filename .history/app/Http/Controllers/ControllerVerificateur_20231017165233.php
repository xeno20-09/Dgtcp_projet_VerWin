...
class ControllerVerificateur extends Controller
{
    ...
    public function checkref($libellePiece, $referencePiece, $datePiece, $montantligne,  $dateExpi, $idm)
    {
        ...
        return view('verificateur.infopiece', compact('montantligne', 'libellePiece', 'datePiece', 'montantdmd', 'restant', 'referencesPieces', 'e', 'dmd_back', 'date', 'demande', 'dmd_n_lu', 'user'));
    }
