...
class ControllerSecretaire extends Controller
{
    ...
    {
        // Modifiez la clé pour correspondre à l'attribut 'name' de votre champ de sélection
        $monnaie = $request->input('monnaie'); // Utilisez 'devise' au lieu de 'currency_from'

        $devise = devises::where('devise', '=', $monnaie)->get();
        if ($devise) {
        ...
        $devise = devise::where('devise', $monnaie)->first();
