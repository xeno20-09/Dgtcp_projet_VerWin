...
class ControllerSecretaire extends Controller
{
    ...
    public function store_form_ask(Request $request)
    {
        ...
        $data['montant_in'] = 5000;
        require_once('vendor/autoload.php');

        $client = new \GuzzleHttp\Client();

        $response = $client->request('GET', 'https://api.fastforex.io/convert?from= $data[currency_from]&to=Xof&amount=$data[montant_in"]&api_key=532a95fca3-4671419311-s1e6v8', [
            'headers' => [
