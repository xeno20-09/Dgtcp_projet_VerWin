...
class ControllerDamf extends Controller
{
    ...
    public function liste_dmd_n(Request $request)
    {
         ...
         */
        $demande = demande::where('vu_damf', '=', 0)->where('vu_chef_bureau', '=', 1)->get();
    ...
    public function formulair(Request $request, $id)
    {
        ...
        return view('damf.form_demande', compact('demande', 'piece', 'user', 'dmd_n_lu' ,'taux'));
    }
    ...
    public function stor(Request $request, $idc)
    {
        ...
        */
        ...
        return redirect('/liste_dmd')->with('demande', 'dmd_n_lu', 'user', 'jointure', 'jointure1', 'jointure2', 'jointure3', 'taux_d');
    }
