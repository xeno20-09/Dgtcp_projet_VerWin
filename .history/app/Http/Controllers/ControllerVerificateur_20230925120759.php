...
*/
    ...
    public function liste(Request $request)
    {
        ...
        $demande = demande::where('id_verifi', '=', $id)->where('vu_verifi', '=', 0)->where('vu_secret', '=', 1)->get();
        $le_n_dmd = count($demande);
    ...
    public function   detaille(Request $request, $id)
    {
        ...
        return view('verificateur.detaille_demande', compact('demande', 'pieces', 'dmd_back', 'user', 'dmd_n_lu', 'jointure'));
    }
