...
class ControllerVerificateur extends Controller
{
    ...
    public function store(Request $request, $idc)
    {
        ...
        foreach ($data['pieces_doss'] as $key => $pieces_doss) {
            ...
            $dmd_verificateur->pieces = $dmd_verificateur->pieces = $data['pieces_doss'][$key] . 'et';

            $dmd_verificateur->refpiece = $data['ref_doss'][$key] . 'et';

            $dmd_verificateur->dateexpi = $data['exp_pieces'][$key] . 'et';
