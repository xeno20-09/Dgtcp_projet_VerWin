...
class ControllerDivision extends Controller
{
    ...
    public function liste_demandes_n(Request $request)
    {
        ...
        return view('chef_division.liste_demande_n', compact('user'        $dmd_n_lu = count(demande::where('vu_chef_division', '=', 0)->get()) - $dmd_back;, 'demande', 'jointure', 'jointure1', 'dmd_n_lu'));
    }
