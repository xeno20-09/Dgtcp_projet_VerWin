...
class ControllerVerificateur extends Controller
{
    ...
    public function store(Request $request, $idc)
    {
        ...
        dd($data['pieces_doss']);
        for ($i = 0; $i <= count($data['pieces_doss']); $i++) {
            // ...
            // Autres traitements
            // ...
            ...
            $this->checkref(
                $libellePiece = $data['pieces_doss'][$i], // $libellePiece
                $referencePiece = $data['ref_doss'][$i], // $referencePiece
                $datePiece = $data['exp_pieces'][$i], // $datePiece
                $idc // $idm
            );
        }
    }
