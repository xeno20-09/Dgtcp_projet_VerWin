...
*/
        ...
        $url = curl_init('http://api.exchangerate.host/historical?access_key=' . $access_key . '&date=' . $date . '&source=' . 'XOF');
        ...
        $q = $r['quotes'];
        $keysToDelete = [132, 153, 159, 160, 161, 162, 163, 166, 21, 25, 30, 36];
        ...
        // À ce stade, les clés spécifiées dans $keysToDelete ont été supprimées de $q
        Ce code vérifie d'abord si chaque clé spécifiée dans le tableau $keysToDelete existe dans le tableau $q en utilisant array_key_exists, puis supprime la clé si elle existe en utilisant unset. Cela vous permet de supprimer les clés spécifiques du tableau $q.
        ...
        $unwantedKeys = [21, 25, 30, 36, 132, 153, 159, 160, 161, 162, 163, 166];
