...
class ControllerDivision extends Controller
{
    ...
    public function   devise(Request $request, $id)
    {
        ...
        if($r['success']==true){
            return redirect('/ListeDeviseMj')->with('demande', 'dmd_back', 'dmd_n_lu', 'user');
    ...
    public function get_devis_mj()  {
        ...
        return view('chef_division.listedevisemj', compact('user', 'ladate', 'devises', 'dmd_n_lu', 'date', 'dmd_back', 'devise'));   
