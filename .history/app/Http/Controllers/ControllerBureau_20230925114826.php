...
class ControllerBureau extends Controller
{
    ...
    public function liste_demand_n(Request $request)
    {
        $id = Auth::id();
        $user = User::where('id', '=', $id)->get();
        $demande = demande::where('status_dmd', '=', 'En cours')->where('vu_chef_division', '=', 1)->where('vu_chef_bureau', '=', 0)->get();
    ...
    public function formulair(Request $request, $id)
    {
        ...
        $demande = demande::where('status_dmd', '=', 'En cours')->where('vu_chef_division', '=', 1)->where('vu_chef_bureau', '=', 0)->where('id', '=', $id)->get();
    ...
    public function  form(Request $request, $id_dmd)
    {
        ...
        return view('chef_bureau.formcb_demande_mj', compact('demande', 'piece', 'dmd_back', 'dmd_n_lu', 'user'));
    }
    public function stor(Request $request, $idc)
    {
        ...
        $dmd_n_lu = count(demande::where('vu_chef_bureau', '=', 0)->where('vu_chef_division', '=', 1)->get());
        $demande = demande::where('vu_chef_division', '=', 1)->where('vu_chef_bureau', '=', 1)->get();
        ...
        return view('chef_bureau.liste_demande', with('demande', 'dmd_back', 'dmd_n_lu', 'user', 'jointure', 'jointure1', 'jointure2'));
    }
    ...
    public function retour(Request $request, $idc)
    {
        ...
        // Redirection vers la page de liste des produits  
        $demande = demande::where('status_dmd', '=', 'En cours')->where('vu_chef_division', '=', 1)->where('vu_chef_bureau', '=', 1)->get();
        $le_n_dmd = count($demande);
    ...
    public function listeretour(Request $request)
    {
        ...
        // Redirection vers la page de liste des produits  
        $demande = demande::where('id_chef_bureau', '=', $id)->where('back_chef_bureau', '=', 1)->get();
        $le_n_dmd = count($demande);
        ...
        return view('chef_bureau.liste_dmd_back', compact('demande', 'dmd_back', 'dmd_n_lu', 'user', 'jointure', 'jointure1', 'jointure2'));
    }
}
