...
class ControllerDamf extends Controller
{
    ...
    {
        $id = Auth::id();
        $user = User::where('id', '=', $id) ->where('vu_chef_bureau', '=', 1)->get();
        /*         $demande = demande::where('vu_chef_bureau', '=', 1)->where('vu_damf', '=', 0)->get();
         */
        $demande = demande::where('vu_damf', '=', 0)->get();
    ...
    public function formulair(Request $request, $id)
    {
        ...
        return view('damf.form_demande', compact('demande', 'piece', 'user', 'dmd_n_lu'));
    }
    public function form(Request $request, $id_dmd)
    {
        ...
        return view('damf.formda_demande_mj', compact('demande', 'piece', 'dmd_n_lu', 'user'));
    }
 ...
 */
        ...
        $demande = demande::where('vu_chef_bureau', '=', 1)
            ->where('vu_damf', '=', 1)
            ->get();

        return redirect('/liste_dmd')->with('demande', 'dmd_n_lu', 'user', 'jointure', 'jointure1', 'jointure2', 'jointure3');
    }
    ...
    public function liste_dmd(Request $request)
    {
        ...
        return view('damf.liste_demande', compact('demande', 'piece', 'dmd_n_lu', 'user', 'jointure', 'jointure1', 'jointure2', 'jointure3', 'dmd_n_lu'));
    }
    ...
    public function retour(Request $request, $idc)
    {
        ...
        return view('damf.liste_demande', compact('demande', 'dmd_n_lu', 'piece', 'user', 'jointure', 'jointure1', 'jointure2', 'jointure3', 'dmd_n_lu'));
    }
}
