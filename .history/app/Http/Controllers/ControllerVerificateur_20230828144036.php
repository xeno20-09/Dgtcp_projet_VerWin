...
class ControllerVerificateur extends Controller
{
    ...
    public function retour(Request $request, $idc)
    {
        ...
        return view('verificateur.liste_demande_n', compact('demande', 'dmd_back', 'dmd_n_lu', 'user', 'jointure'));
    }
    ...
    public function listeretour(Request $request)
    {
        ...
        return view('verificateur.liste_demande_n', compact('demande', 'dmd_back', 'user', 'jointure', 'dmd_n_lu'));
    }
}
