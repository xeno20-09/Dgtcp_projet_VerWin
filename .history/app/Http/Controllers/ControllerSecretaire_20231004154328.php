...
class ControllerSecretaire extends Controller
{
    ...
    public function store_form_ask(Request $request)
    {
        ...
        $dmd_secretaire->montant = ($data['currency_from'])$dmd_secretaire->montant = ($data['montant_in']); $dmd_secretaire->montant = ($data['currency_in'])  $dmd_secretaire->montant = ($data['valeur'])
