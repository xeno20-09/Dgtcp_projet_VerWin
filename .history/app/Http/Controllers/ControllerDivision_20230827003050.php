...
class ControllerDivision extends Controller
{
    public function home()
    {
        ...
        $dmd_back = count(demande::where('back_chef_division', '=', 1)->where('vu_verifi', '=', 1)->where('vu_chef_division', '=', 1)->get());
    ...
    public function   detailles(Request $request, $id)
    {
        ...
        return view('chef_division.detaille_demande', compact('demande', 'dmd_back', 'user', 'dmd_n_lu', 'jointure', 'jointure1', 'dmd_n_lu'));
    }
