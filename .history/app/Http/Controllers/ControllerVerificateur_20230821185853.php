...
class ControllerVerificateur extends Controller
{
    ...
    public function store_piece_dmd(Request $request, $id_d)
    {
        ...
        $data = $request->all();
        $libellePieces = $request->input('libellepiece');
        $referencesPieces = $request->input('referencespiece');
        $datesPieces = $request->input('date_piece');
        $montantLignes = $request->input('montantligne');
    ...
    public function store(Request $request, $idc)
    {
        ...
        if ($request->hasFile('file')) {
            ...
            return view('verificateur.infopiece', compact('numberinput', 'file', 'date', 'demande', 'dmd_n_lu', 'user', 'jointure'));
        } else {
