    ...
    public function store_piece_dmd(Request $request, $id_d)
    {
        ...
        if (isset($data['libellepiece'])) {
            ...
            $dmd_pieces = new piece();
                $dmd_pieces->libellepiece = $libellePieces;
                $dmd_pieces->referencespiece = $referencesPieces;
                $dmd_pieces->date_piece = $datesPieces;
                $dmd_pieces->montantligne = $montantLignes;
