...
class ControllerVerificateur extends Controller
{
    ...
    public function store(Request $request, $idc)
    {
        ...
        $dmd_verificateur->id_verifi = $data['pieces_doss'];
        ...
        $dmd_verificateur->nombre_doc = $compteurVirgule;
        ...
        return view('verificateur.savepiece', compact('demande', 'dmd_back', 'dmd_n_lu', 'user', 'jointure'));
    }
