...
class ControllerSecretaire extends Controller
{
    ...
    public function store_form_ask(Request $request)
    {
        ...
        $dmd_secretaire->type_prs = $data['date_depot'];

         => "morale"
        "nature_op" => "Fugit accusamus optio architecto blanditiis eaque vitae ab illo."
        "nature_pro" => "Lead Response Director"
        "nationalite" => "AFG"
        "currency_from" => "null"
        "montant_in" => "540"
        "nom_client" => null
        "prenom_client" => null
        "profess_client" => null
        "tel_client" => "831-278-3176"
        "banque_client" => "Société générale de banques du Bénin"
        "num_compt_client" => "Carrie"
        "boite" => "New Mexico"
        "currency_from_m" => "Yen japonais"
        "nomsociete" => "Louisiana"
        "categorie" => "West Virginia"
        "adresse" => "2133 Vallie Crossing"
