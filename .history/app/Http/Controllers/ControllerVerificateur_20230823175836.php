...
class ControllerVerificateur extends Controller
{
    ...
    public function store_piece_dmd(Request $request, $id_d)
    {
        ...
        $dmd_verificateur->update();
        $demandePiece::where('nom_v', $n_verificateur)->get();
        return view('verificateur.recap_pieces', compact('numberinput', 'filewithoutext', 'file', 'date', 'demande', 'dmd_n_lu', 'user', 'jointure'));
    }
