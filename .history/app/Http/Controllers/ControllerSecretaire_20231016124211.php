...
public function get_rec_ask(Request $request,$id) {
 	...
 	4 	nature_p 	nature_op 	montant 	montant_con devise 	num_save 	nom_client 	type_prs 	boite 	adresse 	nomsociete 	prenom_client 	profess_client 	tel_client 	banque_client 	num_compt_client
