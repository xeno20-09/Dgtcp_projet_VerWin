...
class ControllerVerificateur extends Controller
{
    ...
    public function checkref( $data['pieces_doss'], $referencePiece, $datePiece, $idm)
    {
        $data['pieces_doss'][$key], // $libellePiece
                $data['ref_doss'][$key], // $referencePiece
                $data['exp_pieces'][$key]
        $id = Auth::id();
