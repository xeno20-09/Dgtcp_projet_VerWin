 ...
 */
    ...
    public function listedmd(Request $request)
    {
        ...
        if ($status != 'All') {
            ...
            return view('Admin_SGBD.liste', compact('demande', 'number', 'user', 'jointure', 'jointure1', 'jointure2', 'jointure3'));
        } else {
    ...
    public function   detailles(Request $request, $id)
    {
        ...
        return view('Admin_SGBD.detaille_demande', compact('demande','stastus', 'piece', 'user', 'dmd_n_lu', 'jointure', 'jointure1', 'jointure2', 'jointure3'));
    }
