...
*/
        ...
        if (($dmd_verificateur == null) && ($demand->nombre_doc != 0)) {
            //  dd($dmd_verificateur);
            return view('verificateur.infopiece', compact('e', 'montantligne', 'libellePiece', 'referencePiece', 'datePiece', 'montantdmd', 'restant', 'referencesPieces', 'e', 'dmd_back', 'date', 'demande', 'dmd_n_lu', 'user'));
        }
    }
