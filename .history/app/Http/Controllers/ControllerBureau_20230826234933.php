...
class ControllerBureau extends Controller
{
    ...
    public function liste_demand_n(Request $request)
    {
        ...
        $jointure2 = DB::table('users')
            ...
            ->select('demandes.*', 'users.*')
            ->get();
        $dmd_n_lu = count(demande::where('vu_chef_bureau', '=', 0)->get());        $dmd_back = count(demande::where('back_chef_division', '=', 1)->where('vu_chef_bureau', '=', 1)->where('vu_chef_division', '=', 1)->get());
        $dmd_n_lu = count(demande::where('vu_chef_bureau', '=', 0)->get()) - $dmd_back;
    ...
    public function formulair(Request $request, $id)
    {
        ...
        $dmd_n_lu = count(demande::where('vu_chef_bureau', '=', 0)->get()) - $dmd_back;
, 'dmd_back'
        return view('chef_bureau.form_demande', compact('demande'        $dmd_back = count(demande::where('back_chef_division', '=', 1)->where('vu_chef_bureau', '=', 1)->where('vu_chef_division', '=', 1)->get());
        $dmd_n_lu = count(demande::where('vu_chef_bureau', '=', 0)->get()) - $dmd_back;
, 'dmd_back', 'user', 'dmd_n_lu'));
    }
    public function  form(Request $request, $id_dmd)
    {
        ...
        $demande = (demande::where('id', '=', $id_dmd)->get());        $dmd_back = count(demande::where('back_chef_division', '=', 1)->where('vu_chef_bureau', '=', 1)->where('vu_chef_division', '=', 1)->get());
        $dmd_n_lu = count(demande::where('vu_chef_bureau', '=', 0)->get()) - $dmd_back;
, 'dmd_back'

        return view('chef_bureau.formcb_demande_mj', compact('demande'        $dmd_back = count(demande::where('back_chef_division', '=', 1)->where('vu_chef_bureau', '=', 1)->where('vu_chef_division', '=', 1)->get());
        $dmd_n_lu = count(demande::where('vu_chef_bureau', '=', 0)->get()) - $dmd_back;
, 'dmd_back', 'dmd_n_lu', 'user'));
    }
    public function stor(Request $request, $idc)
    {
        ...
        $jointure2 = DB::table('users')
            ->join('demandes', 'users.id', '=', 'demandes.id_chef_division')
            ->select('demandes.*', 'users.*')
            ->get();        $dmd_back = count(demande::where('back_chef_division', '=', 1)->where('vu_chef_bureau', '=', 1)->where('vu_chef_division', '=', 1)->get());
        $dmd_n_lu = count(demande::where('vu_chef_bureau', '=', 0)->get()) - $dmd_back;
, 'dmd_back'
        return view('chef_bureau.liste_demande', compact('demande'        $dmd_back = count(demande::where('back_chef_division', '=', 1)->where('vu_chef_bureau', '=', 1)->where('vu_chef_division', '=', 1)->get());
        $dmd_n_lu = count(demande::where('vu_chef_bureau', '=', 0)->get()) - $dmd_back;
, 'dmd_back', 'dmd_n_lu', 'user', 'jointure', 'jointure1', 'jointure2'));
    }
...
, 'dmd_back'
        ...
        return view('chef_bureau.detaille_demande', compact('demande'        $dmd_back = count(demande::where('back_chef_division', '=', 1)->where('vu_chef_bureau', '=', 1)->where('vu_chef_division', '=', 1)->get());
        $dmd_n_lu = count(demande::where('vu_chef_bureau', '=', 0)->get()) - $dmd_back;
, 'dmd_back', 'user', 'dmd_n_lu', 'jointure', 'jointure1', 'jointure2'));
    }
}
