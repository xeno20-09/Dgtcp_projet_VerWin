...
class ControllerDivision extends Controller
{
    public function home()
    {
        ...
        $dmd_n_lu = count(demande::where('vu_chef_division', '=', 0)->where('vu_verifi', '=', 1)->get());
    ...
    public function liste_demandes_n(Request $request)
    {
        $id = Auth::id();
        $user = User::where('id', '=', $id)->get();
        $demande = demande::where('status_dmd', '=', 'En cours')->where('vu_verifi', '=', 1)->where('date_decision', '=', null)->get();
    ...
    public function listeretour(Request $request)
    {
        ...
        return view('chef_division.liste_dmd_back', compact('demande', 'dmd_back', 'dmd_n_lu', 'user', 'jointure', 'jointure1', 'dmd_n_lu'));
    }
}
