...
dd(count($referencesPieces))
            $dmd_verificateur = piece::where('referencespiece', '=', $referencesPieces[count($referencesPieces)])->orderByDesc('created_at')->first()/* find($referencesPieces[$i]) */;
