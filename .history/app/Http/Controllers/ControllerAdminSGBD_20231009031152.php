...
class ControllerAdminSGBD extends Controller
{
    ...
    public function getetatdmd()
    {
        ...
        return view('Admin_SGBD.etats', compact('user', 'liste', 'date', 'groupedDemandes', 'devise', 'grouped', 'group'));
    }
    ...
    public function getpays()
    {
        ...
        return view('Admin_SGBD.etatpays', compact('grouped'));
    }
    ...
    public function getdevis()
    {
        ...
        return view('Admin_SGBD.etatdevise', compact('groupedDemandes'));
    }
    ...
    public function getsociete()
    {
        ...
        return view('Admin_SGBD.etatsociete', compact('group'));
    }
 ...
 */
    ...
    public function lalistedmd(Request $request)
    {
        // Récupérez les données du formulaire
        $status = $request->input('status');
        $fdate = $request->input('fdate');
        ...
        if ($status != 'All') {
            ...
            // Utilisez la méthode whereNotNull pour vous assurer que les champs ne sont pas vides
            $demande = demande::where('devise', $devise)
                ->whereBetween('date', [$fdate, $sdate])
                ->get();
            $id = Auth::id();
