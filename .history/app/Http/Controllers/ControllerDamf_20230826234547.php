...
class ControllerDamf extends Controller
{
    public function home()
    {
        ...
        $dmd_n_lu = count(demande::where('vu_damf', '=', 0)->get());    $dmd_back = count(demande::where('back_chef_bureau', '=', 1)->where('vu_damf', '=', 1)->where('vu_chef_bureau', '=', 1)->get());
        $dmd_n_lu = count(demande::where('vu_damf', '=', 0)->get())-$dmd_back;


        return view('damf.Home', compact('user', 'le_n_dmd_c', 'dmd_back', 'le_n_dmd_v', 'le_n_dmd_e', 'le_n_dmd_s', 'dmd_n_lu'));
    }
    ...
    public function liste_dmd_n(Request $request)
    {
        ...
        return view('damf.liste_demande_n', compact('user', 'dmd_back', 'demande', 'jointure', 'jointure1', 'jointure2', 'jointure3', 'dmd_n_lu'));
    }
    public function formulair(Request $request, $id)
    {
        ...
        $dmd_n_lu = count(demande::where('vu_damf', '=', 0)->get());
        $dmd_damf = demande::find($id);
        $dmd_damf->vu_damf =  1;
        $dmd_damf->update();
        $dmd_back = count(demande::where('back_chef_bureau', '=', 1)->where('vu_damf', '=', 1)->where('vu_chef_bureau', '=', 1)->get());
        $dmd_n_lu = count(demande::where('vu_damf', '=', 0)->get()) - $dmd_back;

        return view('damf.form_demande', compact('demande', 'dmd_back', 'user', 'dmd_n_lu'));
    }
    public function  form(Request $request, $id_dmd)
    {
        ...
        return view('damf.formda_demande_mj', compact('demande', 'dmd_back', 'dmd_n_lu', 'user'));
    }
    public function stor(Request $request, $idc)
    {
        ...
        return view('damf.liste_demande', compact('demande', 'dmd_n_lu', 'dmd_back', 'user', 'jointure', 'jointure1', 'jointure2', 'jointure3'));
    }
    ...
    public function   detailles(Request $request, $id)
    {
        ...
        return view('damf.detaille_demande', compact('demande', 'user', 'dmd_back', 'dmd_n_lu', 'jointure', 'jointure1', 'jointure2', 'jointure3'));
    }
    ...
    public function retour(Request $request, $id)
    {
        ...
        return view('damf.liste_demande', compact('demande', 'dmd_n_lu', 'dmd_back', 'user', 'jointure', 'jointure1', 'jointure2', 'jointure3', 'dmd_n_lu'));
    }
}
