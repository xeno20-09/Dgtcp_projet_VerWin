        ...
        if ($request->hasFile('file')) {
            foreach ($request->file('file') as $file) {
                if ($file->isValid()) {
                    ...
                    // Stocker le nom du fichier dans votre modèle ou faire le traitement approprié
                    // Par exemple, ajouter le nom du fichier à un tableau si vous souhaitez enregistrer plusieurs noms de fichiers
                }
            }
        }
