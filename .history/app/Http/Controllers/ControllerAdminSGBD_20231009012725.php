...
class ControllerAdminSGBD extends Controller
{
    ...
    public function getetatdmd()
    {
        ...
        DB::raw('SUM(montant) as total') signifie "calcule la somme de la colonne 'montant' dans la table de la base de données et donne-lui le nom 'total'".
         Cela permet de récupérer le total calculé dans les résultats de la requête avec le nom "total".
