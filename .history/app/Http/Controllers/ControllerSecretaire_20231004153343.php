...
class ControllerSecretaire extends Controller
{
    ...
    public function store_form_ask(Request $request)
    {
        ...
        "nom_demandeur" => null
        "mail_demandeur" => null
        "poste_demandeur" => "Agent de saisir"
        "_token" => "ASj2hX4dhyR4MvRmBdWS7xTAixbSEJcumJRLmLG3"
        "date_depot" => "2024-03-04 15:05:48"
        "type" => "morale"
        "nature_op" => "Error molestiae dignissimos unde libero soluta ipsum blanditiis veritatis."
        "nature_pro" => "Senior Marketing Officer"
        "nationalite" => "AFG"
        "currency_from" => "null"
        "montant_in" => "190"
        "nom_client" => null
        "prenom_client" => null
        "profess_client" => null
        "tel_client" => "777-918-8625"
        "banque_client" => "BGFIBank Bénin"
        "num_compt_client" => "Heaven"
        "boite" => "Colorado"
        "currency_from_m" => "Yen japonais"
        "nomsociete" => "Ohio"
        "categorie" => "Ohio"
        "adresse" => "9109 Hegmann Burg"
        if (request()->validate([
