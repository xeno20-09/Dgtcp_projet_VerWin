...
if($dmd_verificateur){
    ...
    $notfound++;
        ...
        $dmd_back = count(demande::where('back_verifi', '=', 1)->get());
        return view('verificateur.infopiece', compact('montantligne','found','notfound', 'libellePiece', 'datePiece', 'montantdmd', 'referencePiece', 'dmd_back', 'demande', 'dmd_n_lu', 'user'));
    }
