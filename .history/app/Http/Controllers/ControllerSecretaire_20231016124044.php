...
public function get_rec_ask(Request $request,$id) {
           ...
           $demande =demande::where('id_dmd','=',$id);
           // share data to view
           view()->share('demande', $demande);
           
Textes complets
id 	numero_doss 	date 	nature_p 	nature_op 	montant 	montant_con 	devise 	valeur 	num_save 	nom_client 	type_prs 	nationalite 	categorie 	boite 	adresse 	nomsociete 	prenom_client 	profess_client 	tel_client 	banque_client 	num_compt_client 	id_secret 	status_dmd 	vu_secret
           $pdf = PDF::loadView('secretaire.pdf_recu', $data = ['numero_doss', '', 'poste', 'created_at']);
