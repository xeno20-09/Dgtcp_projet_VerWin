  ...
  <div class="col">
      <div class="form-group">
        <label for="" class="form-label mt-4">Date de dépôt du dossier</label>
            <input name="date_depot" type="texte"  class="form-control" id="" aria-describedby="" placeholder="">
      </div>
    </div>
    <div class="col">
      <div class="form-group">
  ...
  <div class="col">
      <div class="form-group">
        <label for="" class="form-label mt-4">Numero du dossier</label>
            <input name="numero_dossier" type="texte"  class="form-control" id="" aria-describedby="" placeholder="">
      </div>
    </div>
    <div class="col">
      <div class="form-group">
        <label for="" class="form-label mt-4">Numéro de compte client</label>
        <input maxlength="16" minlength="16" name="num_compt_client" type="text" class="form-control" id="" placeholder="Numéro de compte">
      </div>
    </div>
    <div class="col">
      <div class="form-group">
        <label for="" class="form-label mt-4">Numéro de compte beneficiere</label>
        <input maxlength="16" minlength="16" name="num_compt_benefi" type="text" class="form-control" id="" placeholder="Numéro de compte">
      </div>
    </div>
  </div>
