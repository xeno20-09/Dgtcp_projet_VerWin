...
<body>
  <div class="d-flex justify-content-between align-items-center text-center p-3 bg-primary text-center text-white" style="background-color: rgba(0, 0, 0, 0.2);">
  ...
  <div class="container mt-4">
    ...
    <p>Si vous n'êtes pas à l'origine de la création de ce compte, ne tenez pas compte de cet email. Le compte sera automatiquement supprimé.</p>
  </div>
  ...
  <!-- Bootstrap JS -->
  <script src="https://cdn.jsdelivr.net/npm/bootstrap@5.3.0-alpha3/dist/js/bootstrap.bundle.min.js" integrity="sha384-mD+R+teG5dH/wS9TQgG7bhkFt+OHx6lBo8BwHVGsHFKfkuCm29Db/W1yjwvBLRn5" crossorigin="anonymous"></script>
</body>
