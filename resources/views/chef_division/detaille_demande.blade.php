                                ...
                                <div>
                                    <nav aria-label="breadcrumb">
                                        <ol class="breadcrumb mb-2">
                                            ...
                                            <li class="breadcrumb-item"><a href="{{ url('HSecretaire') }}">Tableau de
                                                    bord</a></li>
                                            <li class="breadcrumb-item active" aria-current="page">Détails de la demande
                                            </li>
                                        </ol>
                                    </nav>
                                                ...
                                                <div class="row g-3">
                                                    ...
                                                    <div class="col-6">
                                                        <label class="form-label text-sm text-muted mb-1">Nature des
                                                            produits</label>
                                                        <p class="mb-0 text-dark font-weight-bold">{{ $item->nature_p }}
                                                        </p>
                                                    </div>
                                                    <div class="col-6">
                                                        <label class="form-label text-sm text-muted mb-1">Nature des
                                                ...
                                                @foreach ($demande as $item)
                                                    ...
                                                    <div
                                                        ...
                                                        <div class="timeline-content">
                                                            ...
                                                            <p class="text-sm text-muted mb-0">
                                                                @if ($item->vu_damf)
                                                                    <span class="text-success">Décision finale
                                                                        prise</span>
                                                                @else
                                                                    <span class="text-warning">En attente de
                                                                        décision</span>
                                                                @endif
                                                            </p>
                                                        </div>
                                            ...
                                            @foreach ($demande as $item)
                                                @if ($item->nom_client)
                                                    ...
                                                    <div class="row g-3">
                                                        ...
                                                        <div class="col-md-4">
                                                            <label
                                                                class="form-label text-sm text-muted mb-1">Profession</label>
                                                            <p class="mb-0 text-dark font-weight-bold">
                                                                {{ $item->profess_client }}</p>
                                                        </div>
                                                        <div class="col-md-4">
                                                            <label
                                                                class="form-label text-sm text-muted mb-1">Téléphone</label>
                                                            <p class="mb-0 text-dark font-weight-bold">
                                                                <a href="tel:{{ $item->tel_client }}"
                                                        ...
                                                        @if ($item->nationalite)
                                                            <div class="col-md-4">
                                                                <label
                                                                    class="form-label text-sm text-muted mb-1">Nationalité</label>
                                                                <p class="mb-0 text-dark font-weight-bold">
                                                                    {{ $item->nationalite }}</p>
                                                            </div>
                                                        @endif
                                                ...
                                                @elseif ($item->nomsociete)
                                                    ...
                                                    <div class="row g-3">
                                                        <div class="col-md-4">
                                                            <label class="form-label text-sm text-muted mb-1">Nom de la
                                                                société</label>
                                                            <p class="mb-0 text-dark font-weight-bold">
                                                                {{ $item->nomsociete }}</p>
                                                        </div>
                                                        <div class="col-md-4">
                                                            <label
                                                                class="form-label text-sm text-muted mb-1">Catégorie</label>
                                                            <p class="mb-0 text-dark font-weight-bold">
                                                                {{ $item->categorie }}</p>
                                                        </div>
                                                        <div class="col-md-4">
                                                            <label
                                                                class="form-label text-sm text-muted mb-1">Adresse</label>
                                                            <p class="mb-0 text-dark font-weight-bold">
                                                                {{ $item->adresse }}</p>
                                                        </div>
                                                        <div class="col-md-4">
                                                        ...
                                                        @if ($item->boite)
                                                            <div class="col-md-4">
                                                                <label class="form-label text-sm text-muted mb-1">Boîte
                                                                    postale</label>
                                                                <p class="mb-0 text-dark font-weight-bold">
                                                                    {{ $item->boite }}</p>
                                                            </div>
                                                ...
                                                <div class="row g-3">
                                                    ...
                                                    <div class="col-md-4">
                                                        <label
                                                            class="form-label text-sm text-muted mb-1">Profession</label>
                                                        <p class="mb-0 text-dark font-weight-bold">
                                                            {{ $item->profess_benefi ?? 'Non spécifié' }}</p>
                                                    </div>
                                                    <div class="col-md-4">
                                                        <label
                                                            class="form-label text-sm text-muted mb-1">Banque</label>
                                                        ...
                                                        <tbody>
                                                            @foreach ($pieces as $piece)
                                                                <tr>
                                                                    ...
                                                                    <td>{{ number_format($piece->montantinitial, 2, ',', ' ') }}
                                                                    </td>
                                                                    <td>{{ number_format($piece->montantligne, 2, ',', ' ') }}
                                                                    </td>
                                                                    <td>{{ number_format($piece->montantrestant, 2, ',', ' ') }}
                                                                    </td>
                                                                    <td>
                                                                        @if ($piece->dateexpi)
