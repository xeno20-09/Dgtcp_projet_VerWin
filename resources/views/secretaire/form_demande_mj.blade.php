                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <select class="form-select position-relative"
                                            ...
                                            name="type" required>
                                            <option value="{{ $item1->type_prs }}">Personne {{ $item1->type_prs }}
                                            </option>
                                    ...
                                    <div class="row mt-3">
                                        <div class="col-md-3">
                                            <div class="form-group">
                                                ...
                                                <select style="top: 0px;" id="currency_from_m"
                                                    ...
                                                    aria-label="Default select example" onchange="valeur_m()"
                                                    required>
                                                    <option value="{{ $item1->devise }}">{{ $item1->devise }}
                                                    </option>
                                                    ...
                                                    <option value="Dirham Emirats Arabes Unis">Dirham Emirats Arabes
                                                        Unis</option>
                                                </select>
                                            </div>
                                        </div>
                                        <div class="col-md-3">
                                            <div class="form-group">
                                                ...
                                                <input name="montant_in" value="{{ $item1->montant }}"
                                                    type="number" class="form-control" oninput="test1()"
                                                    id="montant_in_m" placeholder="Montant">
                                            </div>
                                        </div>
                                        <div class="col-md-3" id="valeur_m">
                                            <div class="form-group">
                                                ...
                                                <input name="valeur" type="text" class="form-control"
                                                    value="{{ $item1->valeur }}" id="val1" placeholder="Valeur"
                                                    readonly>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                ...
                                                <input name="categorie" type="text"
                                                    value="{{ $item1->categorie }}" class="form-control"
                                        ...
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                ...
                                                <select style="top: 0px;" class="form-select position-relative"
                                                    ...
                                                    <option value="{{ $item1->banque_client }}">
                                                        {{ $item1->banque_client }}</option>
                                                    ...
                                                    <option value="Société générale de banques du Bénin">Société
                                                        générale de banques du Bénin</option>
                                                    <option
                                    ...
                                    <div class="row">
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                <label for="" class="form-label mt-4">Nature des
                                                    opérations</label>
                                                <input name="nature_op" value="{{ $item1->nature_op }}"
                                                    type="text" class="form-control"
                                        ...
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                <label for="" class="form-label mt-4">Nature des
                                                    produits</label>
                                                <input name="nature_pro" value="{{ $item1->nature_p }}"
                                                    type="text" class="form-control"
                                        ...
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                ...
                                                <select class="form-select position-relative" name="nationalite"
                                                    ...
                                                    <option value="{{ $item1->nationalite }}">
                                                        {{ $item1->nationalite }}</option>
                                    ...
                                    <div class="row mt-3">
                                        ...
                                        <div class="col-md-3">
                                            <div class="form-group">
                                                <label for="" class="form-label mt-4">Montant</label>
                                                <input name="montant_in" value="{{ $item1->montant }}"
                                                    type="number" oninput="test()" class="form-control"
                                                    id="montant_in" placeholder="Montant">
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                ...
                                                <input name="nom_client" type="text"
                                                    value="{{ $item1->nom_client }}" class="form-control"
                                        ...
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                ...
                                                <input name="prenom_client" type="text"
                                                    value="{{ $item1->prenom_client }}" class="form-control"
                                                    placeholder="Prénom client">
                                            </div>
                                        </div>
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                <label for="" class="form-label mt-4">Profession
                                                    client</label>
                                                <input name="profess_client" type="text"
                                                    value="{{ $item1->profess_client }}" class="form-control"
                                                    placeholder="Profession client">
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="row mt-3">
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                ...
                                                <input maxlength="14" minlength="12"
                                                    value="{{ $item1->tel_client }}" name="tel_client"
