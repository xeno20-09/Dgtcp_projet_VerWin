                                ...
                                <div class="col-12">
                                    <div class="w-100">
                                        ...
                                        <h4 class="mb-2 font-weight-bold">
                                            {{ $All_info_dmd['Tab_nombre_infos_demandes']['en_cours'] }}</h4>
                            ...
                            <div class="row">
                                <div class="col-12">
                                    <div class="w-100">
                                        ...
                                        <h4 class="mb-2 font-weight-bold">
                                            {{ $All_info_dmd['Tab_nombre_infos_demandes']['validees'] }}</h4>
                                        <div class="d-flex align-items-center">
                                            {{--    <span class="text-sm text-success font-weight-bolder">
                            ...
                            <div class="row">
                                <div class="col-12">
                                    <div class="w-100">
                                        ...
                                        <h4 class="mb-2 font-weight-bold">
                                            {{ $All_info_dmd['Tab_nombre_infos_demandes']['echouees'] }}</h4>
                                        <div class="d-flex align-items-center">
                                            {{--    <span class="text-sm text-success font-weight-bolder">
                            ...
                            <div class="row">
                                <div class="col-12">
                                    <div class="w-100">
                                        ...
                                        <h4 class="mb-2 font-weight-bold">
                                            {{ $All_info_dmd['Tab_nombre_infos_demandes']['suspendues'] }}</h4>
                                        <div class="d-flex align-items-center">
                                            {{--   <span class="text-sm text-success font-weight-bolder">
